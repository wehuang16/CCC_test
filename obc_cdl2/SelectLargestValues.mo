...
model SelectLargestValues "Select largest values"

  Buildings.Controls.OBC.DemandFlexibility.Generic.SelectLargestValues  selLarVal(
    nVal=5) "Block to select largest values"
    annotation (Placement(transformation(extent={{60,0},{80,20}})));
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant con2[4](k={5,5,5,5})
  ...
  Buildings.Controls.OBC.CDL.Reals.Sources.TimeTable sawSig(table=[0,5; 1,5])
                                           "Sawtooth signal"
    annotation (Placement(transformation(extent={{-80,0},{-60,20}})));
equation
  connect(nSel.y,selLarVal. nSel)
    annotation (Line(points={{22,-70},{40,-70},{40,4},{58,4}}, color={255,127,0}));
  connect(con1.y,selLarVal. disFla[2:5])
    annotation (Line(points={{-58,50},{20,50}, {20,16.8},{58,16.8}},
      color={255,0,255}));
  connect(booPul.y,selLarVal. disFla[1])
    annotation (Line(points={{-18,70},{20,70},{20,15.2},{58,15.2}},
      color={255,0,255}));
  connect(con2.y,selLarVal. u[2:5])
    annotation (Line(points={{-18,-30},{20,-30},{20,10.8},{58,10.8}},
      color={0,0,127}));
  connect(sawSig.y[1],selLarVal. u[1])
...
annotation (experiment(StopTime=1, Interval=60, Tolerance=1e-06),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/DemandFlexibility/Generic/Validation/SelectLargestValues.mos"
    "Simulate and plot"),
  Documentation(info="<html>
<p>
This example validates
<a href=\"modelica://Buildings.Controls.OBC.DemandFlexibility.Generic.SelectLargestValues\">
Buildings.Controls.OBC.DemandFlexibility.Generic.SelectLargestValues</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
