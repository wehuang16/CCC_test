...
model EuropeanNorm3D "Data from European Norm in two dimensions"
  extends PartialHeatPumpCycle3D(
...
equation
  ...
  connect(scaFacTimPel.y, feeHeaFloEva.u2) annotation (Line(points={{-40,-19},{
          -40,-24},{-70,-24},{-70,-18}},
                                     color={0,0,127}));
  connect(scaFacTimPel.y, PEle) annotation (Line(points={{-40,-19},{-40,-24},{0,
          -24},{0,-110}}, color={0,0,127}));
  connect(scaFacTimPel.y, redQCon.u2) annotation (Line(points={{-40,-19},{-40,
          -24},{64,-24},{64,-58}},
                              color={0,0,127}));
  connect(scaFacTimQUse_flow.y, feeHeaFloEva.u1) annotation (Line(points={{42,-13},
          {42,-18},{-86,-18},{-86,-10},{-78,-10}}, color={0,0,127}));
  connect(reaPasThrTEvaOut.u, sigBus.TEvaOutMea) annotation (Line(points={{-22,102},
          {-22,104},{1,104}},      color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
  ...
  connect(reaPasThrTConOut.u, sigBus.TConOutMea) annotation (Line(points={{70,
      ...
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  connect(elec_power.u[3], sigBus.ySet) annotation (Line(points={{6.66667,42},{
          8,42},{8,86},{1,86},{1,104}}, color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(condenser_heat.u[3], sigBus.ySet) annotation (Line(points={{74.6667,
          40},{48,40},{48,52},{1,52},{1,104}}, color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
