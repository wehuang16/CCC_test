...
model RefrigerantCycle_3D "Refrigerant cycle model of a heat pump"
  extends
  ...
  EuropeanNorm3D refCycHeaPumHea "Refrigerant cycle instance for heating"
