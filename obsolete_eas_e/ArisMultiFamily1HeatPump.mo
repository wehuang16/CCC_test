...
model ArisMultiFamily1HeatPump
  ...
  CCC_test.obsolete_eas_e.CCC_HP_wTSup_ctr_withPowerData_3D cCC_HP_wTSup_ctr_withPowerData_3D(
  ...
  CCC_test.obsolete_eas_e.FanCoilUnitPid fanCoilUnitPid(
  ...
  CCC_test.obsolete_eas_e.FanCoilUnitPid fanCoilUnitPid1(
    redeclare package Medium1 = MediumPropyleneGlycol (property_T=293.15, X_a=
            0.4),
    redeclare package Medium2 = MediumAir,
    m1_flow_nominal=0.06111,
  ...
  CCC_test.obsolete_eas_e.FanCoilUnitPid fanCoilUnitPid2(
    redeclare package Medium1 = MediumPropyleneGlycol (property_T=293.15, X_a=
            0.4),
    redeclare package Medium2 = MediumAir,
    m1_flow_nominal=0.06111,
    ...
    T_a1_nominal=343.15,
    T_a2_nominal=293.15)
    annotation (Placement(transformation(extent={{420,-358},{440,-338}})));
...
equation
  ...
  connect(fanCoilUnitPid2.port_b2, sou.ports[3]) annotation (Line(points={{419.8,
          -353},{368.5,-353},{368.5,-105.1}},       color={0,127,255}));
  connect(fanCoilUnitPid2.port_a2, sou.ports[4]) annotation (Line(points={{440.2,
          -353.2},{502,-353.2},{502,-148},{369.5,-148},{369.5,-105.1}},
        color={0,127,255}));
  connect(jun2.port_3, fanCoilUnitPid2.port_a1) annotation (Line(points={{64,-186},
          {64,-343.6},{419.8,-343.6}}, color={0,127,255}));
  connect(jun4.port_1, fanCoilUnitPid2.port_b1) annotation (Line(points={{58,-274},
          {454,-274},{454,-343.6},{440.2,-343.6}}, color={0,127,255}));
  ...
  connect(sou.TAir, fanCoilUnitPid2.zonAirTem) annotation (Line(points={{389,-68},
          {400,-68},{400,-358},{418,-358},{418,-356.8}},      color={0,0,127}));
