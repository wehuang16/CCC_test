...
model ArisMultiFamily
  ...
  CCC.Fluid.HeatExchangers.FanCoilUnitPid fanCoilUnitPid(
  ...
  CCC.Fluid.HeatExchangers.FanCoilUnitPid fanCoilUnitPid1(
    redeclare package Medium1 = MediumPropyleneGlycol (property_T=293.15, X_a=
            0.4),
    redeclare package Medium2 = MediumAir,
    m1_flow_nominal=0.06111,
  ...
  CCC.Fluid.HeatExchangers.FanCoilUnitPid fanCoilUnitPid2(
    redeclare package Medium1 = MediumPropyleneGlycol (property_T=293.15, X_a=
            0.4),
    redeclare package Medium2 = MediumAir,
    m1_flow_nominal=0.06111,
