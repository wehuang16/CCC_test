...
replaceable package MediumAir = Buildings.Media.Air;
  ...
  cdl_models.ThermalZones.Subsequences.ModelicaRoom modelicaRoom[nZones](
      heatCapacitor(each C=10*50*1005*1.2))
  ...
  CCC_test.cdl.custom_air_conditioner_OnOff custom_air_conditioner_OnOff[nZones]
    (
  ...
  cdl_models.Controls.Subsequences.temDifSelectionMin ratchetSelection(nValues=
        nZones)
  ...
  cdl_models.Controls.Subsequences.temDifSelectionMax reboundSelection(nValues=
        nZones)
