...
model multiple_zone_ratchet0
  ...
  single_zone_ratchet single_zone_ratchet_cooling[nZones](
  ...
  cdl_models.Controls.Subsequences.temDifSelectionMin temDifSelectionMinHeaRat(nZones=
        nZones)
    annotation (Placement(transformation(extent={{104,78},{124,98}})));
  cdl_models.Controls.Subsequences.temDifSelectionMax temDifSelectionMaxHeaReb(nZones=
        nZones)
  ...
  cdl_models.Controls.Subsequences.temDifSelectionMin temDifSelectionMinCooReb(nZones=
        nZones)
    annotation (Placement(transformation(extent={{126,-108},{146,-88}})));
  cdl_models.Controls.Subsequences.temDifSelectionMax temDifSelectionMaxCooRat(nZones=
        nZones)
