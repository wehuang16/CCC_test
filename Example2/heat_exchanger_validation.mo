...
model heat_exchanger_validation
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort senTemWatIn(
    redeclare package Medium = Medium1,
    allowFlowReversal=false,
    m_flow_nominal=mWat_flow_nominal,
    tau=0) "Temperature sensor"
    annotation (Placement(transformation(extent={{-30,10},{-10,30}})));
  Buildings.Fluid.Sensors.TemperatureTwoPort senTemWatOut(
    redeclare package Medium = Medium1,
    allowFlowReversal=false,
    m_flow_nominal=mWat_flow_nominal,
    tau=0) "Temperature sensor"
    annotation (Placement(transformation(extent={{40,10},{60,30}})));
  Buildings.Fluid.Sensors.TemperatureTwoPort senTemAirIn(
    redeclare package Medium = Medium2,
    allowFlowReversal=false,
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort senTemAirOut(
    redeclare package Medium = Medium2,
    allowFlowReversal=false,
    m_flow_nominal=mAir_flow_nominal,
    tau=0) "Temperature sensor"
