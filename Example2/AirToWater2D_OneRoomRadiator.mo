...
model AirToWater2D_OneRoomRadiator
  ...
  extends
    AixLib.Fluid.HeatPumps.ModularReversible.Examples.BaseClasses.PartialOneRoomRadiator(
  ...
  AixLib.Fluid.HeatPumps.ModularReversible.AirToWaterTableData2D
    heaPum(
    ...
    redeclare
      ...
      datTabHea,
    redeclare
      AixLib.Fluid.Chillers.ModularReversible.Data.TableData2D.EN14511.Vitocal251A08
      datTabCoo,
    redeclare
...
equation
  ...
  annotation (
   __Dymola_Commands(file=
     "modelica://AixLib/Resources/Scripts/Dymola/Fluid/HeatPumps/ModularReversible/Examples/AirToWater2D_OneRoomRadiator.mos"
        "Simulate and plot"),
  experiment(
      StartTime=0,
      StopTime=86400,
