...
model StratifiedLoadingUnloading "Test model for stratified tank"
 ...
 constant Integer nSeg = 7 "Number of segments in tank";
  ...
  Buildings.HeatTransfer.Convection.Interior con1(
    A=1,
    hFixed=0,
    til=0) annotation (Placement(transformation(extent={{112,96},{132,116}})));
...
equation
  ...
  connect(pulse.y, sin_2.m_flow_in) annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.None));
  connect(preTem.port, con1.fluid) annotation (Line(points={{152,46},{172,46},{
          172,106},{132,106}}, color={191,0,0}));
  connect(const.y, preTem.T) annotation (Line(points={{123,-18},{128,-18},{128,
          38},{122,38},{122,46},{130,46}}, color={0,0,127}));
  connect(tanEnh.heaPorSid, con1.solid) annotation (Line(points={{-14.4,8},{-6,
          8},{-6,106},{112,106}}, color={191,0,0}));
