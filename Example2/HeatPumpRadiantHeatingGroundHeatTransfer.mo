...
model HeatPumpRadiantHeatingGroundHeatTransfer
  ...
  Buildings.Controls.OBC.CDL.Reals.Switch swiHeaPum
    "Switch for heat pump signal"
    annotation (Placement(transformation(extent={{-120,-158},{-100,-138}})));
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant off(final k=0)
...
equation
  ...
  connect(const.y, livFlo.T) annotation (Line(points={{39,-100},{48,-100},{48,
          -130},{58,-130}}, color={0,0,127}));
  annotation (
    __Dymola_Commands(
