...
model BaseCoolingVarCOP_weiping_062822
  ...
  ASHPCoolingBlackBox_weiping_062822 AWHP(
...
equation
  ...
  connect(AWHP.TSetSou, TSetASHP) annotation (Line(points={{-54,149.6},{-72,
          149.6},{-72,140},{-120,140}},
                                color={0,0,127}));
  connect(AWHP.TDryBul, uTDryBul) annotation (Line(points={{-54,153},{-120,153},
