...
model Aris_Heat_Pump_Subhrajit_07012024
  ...
  package MediumWater = Buildings.Media.Water;
   ...
   parameter Modelica.Units.SI.MassFlowRate mHP_flow_nominal=0.92 "Nominal mass flow rate from the heat pump";
     parameter Modelica.Units.SI.Power QHP_flow_nominal=18500 "Nominal capacity from the heat pump";
  ...
  CCC.Fluid.BaseClasses.DummyZone dummyZone(vol2(T_start=291.15))
  ...
  Modelica.Blocks.Sources.CombiTimeTable DrawProfile(
    table=[0,0; 300,0; 600,0; 900,1.26180417808599e-05; 1200,0; 1500,0; 1800,0;
        ...
        31800,0; 32100,0; 32400,0; 32700,5.04721671234398e-05; 33000,5.04721671234398e-05;
        33300,1.26180417808599e-05; 33600,0; 33900,0; 34200,0.000176652584932039;
        34500,0.00010094433424688; 34800,0; 35100,0; 35400,0; 35700,1.26180417808599e-05;
        36000,0; 36300,0; 36600,1.26180417808599e-05; 36900,6.30902089042997e-05;
        37200,0; 37500,0; 37800,0; 38100,0; 38400,0; 38700,3.78541253425798e-05;
        39000,0; 39300,0; 39600,0; 39900,0; 40200,0; 40500,1.26180417808599e-05;
        40800,5.04721671234398e-05; 41100,6.30902089042997e-05; 41400,2.52360835617199e-05;
        41700,0; 42000,6.30902089042997e-05; 42300,0.000201888668493759; 42600,8.83262924660196e-05;
        42900,0; 43200,0; 43500,0; 43800,0; 44100,0; 44400,0; 44700,0; 45000,0.000113562376027739;
        45300,0.000201888668493759; 45600,3.78541253425798e-05; 45900,0; 46200,0;
        46500,0; 46800,0; 47100,0; 47400,0; 47700,0; 48000,0; 48300,8.83262924660196e-05;
        48600,0.000201888668493759; 48900,6.30902089042997e-05; 49200,0; 49500,0;
        49800,0; 50100,0; 50400,0; 50700,0; 51000,0; 51300,0; 51600,0; 51900,0;
        52200,0; 52500,0; 52800,0; 53100,0; 53400,8.83262924660196e-05; 53700,3.78541253425798e-05;
        54000,0; 54300,0; 54600,0; 54900,0; 55200,0; 55500,0; 55800,0; 56100,0;
        56400,0; 56700,0; 57000,0; 57300,0; 57600,0; 57900,0; 58200,0; 58500,0;
        58800,0; 59100,0; 59400,0; 59700,0; 60000,0; 60300,0; 60600,0; 60900,0;
        61200,0; 61500,0; 61800,0; 62100,0; 62400,0; 62700,0; 63000,0; 63300,0;
        63600,0; 63900,0; 64200,0.000113562376027739; 64500,7.57082506851597e-05;
        64800,0; 65100,0; 65400,0; 65700,0; 66000,0; 66300,0; 66600,0; 66900,5.04721671234398e-05;
        67200,0; 67500,0; 67800,1.26180417808599e-05; 68100,0; 68400,0; 68700,0;
        69000,0; 69300,0; 69600,0; 69900,0; 70200,0; 70500,0; 70800,0; 71100,0;
        71400,0; 71700,0; 72000,0; 72300,0; 72600,0; 72900,0; 73200,1.26180417808599e-05;
        73500,1.26180417808599e-05; 73800,3.78541253425798e-05; 74100,1.26180417808599e-05;
        74400,2.52360835617199e-05; 74700,0; 75000,0; 75300,1.26180417808599e-05;
        ...
        79800,0; 80100,0; 80400,0; 80700,0; 81000,0; 81300,0; 81600,1.26180417808599e-05;
        81900,1.26180417808599e-05; 82200,0; 82500,0; 82800,0; 83100,0; 83400,0;
        83700,0; 84000,0; 84300,0; 84600,0; 84900,0; 85200,0; 85500,0; 85800,0;
        86100,0; 86400,0],
    smoothness=Modelica.Blocks.Types.Smoothness.ConstantSegments,
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic)
    annotation (Placement(transformation(extent={{-188,-36},{-168,-16}})));
  ...
  Modelica.Blocks.Sources.BooleanConstant bool
    annotation (Placement(transformation(extent={{-246,82},{-226,102}})));
  CCC.Fluid.BaseClasses.HpSetpointController_Subhrajit
    ...
    annotation (Placement(transformation(extent={{-280,48},{-260,72}})));
  Modelica.Blocks.Sources.Constant const(k=0.92)
    annotation (Placement(transformation(extent={{-350,44},{-330,64}})));
  Modelica.Blocks.Sources.Constant const1(k=TankTempSetpoint)
    annotation (Placement(transformation(extent={{-350,-6},{-330,14}})));
  ...
  Modelica.Blocks.Logical.Hysteresis HpHysteresis(
    ...
    pre_y_start=true)
    annotation (Placement(transformation(extent={{104,92},{124,112}})));
...
equation
  connect(fanCoilUnit.port_b2, fan4.port_a) annotation (Line(points={{-16.2,-27},
  ...
  connect(dummyZone.port_b, fanCoilUnit.port_a2) annotation (Line(points={{116.4,
          -46},{134,-46},{134,-27.2},{4.2,-27.2}}, color={0,127,255}));
  connect(dummyZone.port_b, bou.ports[1]) annotation (Line(points={{116.4,-46},{
          140,-46},{140,-64},{146,-64}}, color={0,127,255}));
  connect(fanCoilUnit.m_flow_air, fan4.m_flow_in) annotation (Line(points={{5.2,
  ...
  connect(OAT.y[1], aixlib_AirToWaterHeatPump_3D.TOutAir) annotation (Line(
        points={{99,72},{102,72},{102,54},{38,54},{38,32},{-84,32},{-84,40.7},{-88.7,
          40.7}}, color={0,0,127}));
  connect(val1.port_1, tan.portHex_a) annotation (Line(points={{12,53},{32,53},{
          32,30},{40,30},{40,52},{68,52},{68,35.58},{64,35.58}}, color={0,127,255}));
  connect(tan.portHex_b, val.port_1) annotation (Line(points={{64,31.8},{66,
          31.8},{66,28},{-214,28},{-214,30},{-240,30},{-240,42},{-234,42}},
                                                                  color={0,127,255}));
  connect(val1.port_3, fanCoilUnit.port_a1) annotation (Line(points={{1,42},{1,
          -8},{-20,-8},{-20,-17.6},{-16.2,-17.6}},
                                               color={0,127,255}));
  connect(fanCoilUnit.port_b1, val.port_3) annotation (Line(points={{4.2,-17.6},
          {12,-17.6},{12,32},{-224,32}},         color={0,127,255}));
  ...
  connect(DrawProfile.y[1], UnitConversion.u) annotation (Line(points={{-167,-26},
          {-167,-28},{-150,-28}}, color={0,0,127}));
  connect(UnitConversion.y, pum1.m_flow_in) annotation (Line(points={{-127,-28},
          {-114,-28},{-114,-22},{-106,-22}}, color={0,0,127}));
  connect(pum1.ports[1], tan.port_b) annotation (Line(points={{-84,-30},{-24,-30},
          {-24,18},{44,18},{44,39}}, color={0,127,255}));
  connect(tan.port_a, bou2.ports[1]) annotation (Line(points={{64,39},{114,39},
          {114,40},{164,40}},
                         color={0,127,255}));
  connect(hpSetpointController_Subhrajit.ValCon, val.y) annotation (Line(points={{-258,
          69.2},{-224,69.2},{-224,54}},                           color={0,0,127}));
  connect(hpSetpointController_Subhrajit.ModeHp, aixlib_AirToWaterHeatPump_3D.Mode)
    annotation (Line(points={{-258,66},{-116,66},{-116,60},{-88.8,60},{-88.8,46}},
                       color={255,0,255}));
  connect(hpSetpointController_Subhrajit.TSupSet, aixlib_AirToWaterHeatPump_3D.TSupSet)
    annotation (Line(points={{-258,56.6},{-240,56.6},{-240,62},{-208,62},{-208,
          40.1},{-111.1,40.1}},
                          color={0,0,127}));
  connect(hpSetpointController_Subhrajit.ValCon, val1.y) annotation (Line(
        points={{-258,69.2},{-120,69.2},{-120,100},{1,100},{1,66.2}}, color={0,0,
          127}));
  connect(hpSetpointController_Subhrajit.PumSp, pum.m_flow_in) annotation (Line(
        points={{-258,51},{-238,51},{-238,64},{-72,64},{-72,70},{-56,70},{-56,
          62}},
        color={0,0,127}));
  connect(const.y, hpSetpointController_Subhrajit.PumSpDhw) annotation (Line(
        points={{-329,54},{-292,54},{-292,64},{-282,64}}, color={0,0,127}));
  connect(fanCoilUnit.m_flow_water, hpSetpointController_Subhrajit.PumSpSpaceConditioning)
    annotation (Line(points={{5.2,-13.8},{10,-13.8},{10,30},{-292,30},{-292,52},
          {-290,52},{-290,59.8},{-282,59.8}},
                        color={0,0,127}));
  connect(const1.y, hpSetpointController_Subhrajit.DhwTankTempSetpoint)
    annotation (Line(points={{-329,4},{-290,4},{-290,42},{-282,42},{-282,54.6}},
                                                             color={0,0,127}));
  connect(tan.heaPorVol, Ttank.port) annotation (Line(points={{54,39},{54,70},{38,
          70},{38,86},{44,86}}, color={191,0,0}));
  connect(HpHysteresis.y, not1.u)
    annotation (Line(points={{125,102},{148,102}}, color={255,0,255}));
  connect(Ttank[17].T, HpHysteresis.u) annotation (Line(points={{65,86},{78,86},
          {78,96},{102,96},{102,102}}, color={0,0,127}));
  connect(not1.y, hpSetpointController_Subhrajit.RequestDhw) annotation (Line(
        points={{171,102},{176,102},{176,118},{-292,118},{-292,68},{-282,68}},
                                                                     color={255,
          0,255}));
  connect(dummyZone.zoneTemp, fanCoilUnit.TZon) annotation (Line(points={{118,-40},
          {128,-40},{128,-34},{-1.6,-34}},     color={0,0,127}));
  connect(hpSetpointController_Subhrajit.OnOffHp, aixlib_AirToWaterHeatPump_3D.OnOff)
    annotation (Line(points={{-258,61.8},{-236,61.8},{-236,60},{-116,60},{-116,
          46},{-111.2,46}}, color={255,0,255}));
  connect(val.port_2, senTem.port_a) annotation (Line(points={{-214,42},{-212,
          42},{-212,90},{-184,90}}, color={0,127,255}));
  connect(senTem.port_b, aixlib_AirToWaterHeatPump_3D.port_a) annotation (Line(
        points={{-164,90},{-118,90},{-118,51},{-111,51}}, color={0,127,255}));
  connect(senTem.port_b, bou1.ports[1]) annotation (Line(points={{-164,90},{
          -118,90},{-118,82},{-108,82}}, color={0,127,255}));
  connect(hpSetpointController_Subhrajit.HpReturnTemp, senTem.T) annotation (
      Line(points={{-282,50.6},{-294,50.6},{-294,101},{-174,101}}, color={0,0,
          127}));
...
end Aris_Heat_Pump_Subhrajit_07012024;
