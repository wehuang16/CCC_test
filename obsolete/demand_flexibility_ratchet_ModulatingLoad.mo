...
replaceable package MediumAir = Buildings.Media.Air;
  ...
  DF_Controller_ratchet_cooling_old dF_Controller[nZones](
    ...
    TRatThreshold=0.2,
    TRat=0.5,
    TReb=0.06) annotation (Placement(transformation(extent={{6,62},{26,82}})));
  ...
  cdl_models.HVAC.custom_air_conditioner custom_air_conditioner[nZones](
...
equation
  ...
  connect(custom_air_conditioner.port_b, modelicaRoom.port_a) annotation (Line(
        points={{120.2,14.6},{138,14.6},{138,76.4},{129.4,76.4}}, color={0,127,
          255}));
  connect(modelicaRoom.port_b, custom_air_conditioner.port_a) annotation (Line(
