...
//      ave(nin=3));
  ...
  Modelica.Blocks.Sources.Constant TSup(k=273.15 + 10)
    annotation (Placement(transformation(extent={{298,76},{318,96}})));
  Modelica.Blocks.Sources.Constant TOutCut(k=273.15 + 24)
    annotation (Placement(transformation(extent={{294,20},{314,40}})));
  Modelica.Blocks.Sources.Constant const3(k=350)
    annotation (Placement(transformation(extent={{200,86},{220,106}})));
  Modelica.Blocks.Sources.Constant TMix(k=273.15 + 19.5)
    annotation (Placement(transformation(extent={{-10,-52},{10,-32}})));
  Modelica.Blocks.Sources.Constant VOut_flow(k=0.04)
    annotation (Placement(transformation(extent={{-140,44},{-120,64}})));
equation
  ...
  connect(conAHU.TSup, TSup.y) annotation (Line(points={{356,476.353},{356,76},
          {319,76},{319,86}}, color={0,0,127}));
  connect(conAHU.TOutCut, TOutCut.y) annotation (Line(points={{356,470.706},{
          352,470.706},{352,424},{336,424},{336,112},{280,112},{280,56},{328,56},
          {328,30},{315,30}}, color={0,0,127}));
  connect(conAHU.ducStaPre, const3.y) annotation (Line(points={{356,532.824},{
          252,532.824},{252,96},{221,96}}, color={0,0,127}));
  connect(VOut_flow.y, conAHU.VOut_flow) annotation (Line(points={{-119,54},{
          -90,54},{-90,58},{-61,58},{-61,218},{-18,218},{-18,454},{356,454},{
          356,453.765}}, color={0,0,127}));
  connect(TMix.y, conAHU.TMix) annotation (Line(points={{11,-42},{26,-42},{26,
          14},{40,14},{40,446.235},{356,446.235}}, color={0,0,127}));
  annotation (
...
end FlexlabX1aNoLeakG36Baseline_test1;
