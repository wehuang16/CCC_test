...
equation
  ...
  connect(add.y, add2.u2) annotation (Line(points={{-145,456},{-145,464},{-160,
          464},{-160,364},{-334,364}}, color={0,0,127}));
  ...
  connect(hysteresis.y, conAHU.u_UnOcc) annotation (Line(points={{-390.9,381},{
          ...
          392},{355.6,415.741}}, color={255,0,255}));
  ...
  connect(integerConstant1.y, conAHU.uOpeMod) annotation (Line(points={{-31,290},
          ...
          438.706}}, color={255,127,0}));
  connect(conVAVSou.uOpeMod, integerConstant1.y) annotation (Line(points={{1018,
          32},{502,32},{502,325},{254,325},{254,302},{112,302},{112,290},{-31,
          290}}, color={255,127,0}));
  connect(conVAVCor.uOpeMod, integerConstant1.y) annotation (Line(points={{778,
          104},{34,104},{34,156},{0,156},{0,290},{-31,290}}, color={255,127,0}));
  connect(conVAVNor.uOpeMod, integerConstant1.y) annotation (Line(points={{652,
          4},{54,4},{54,202},{12,202},{12,290},{-31,290}}, color={255,127,0}));
  ...
  connect(yFreCooCoi4.y, add.u1) annotation (Line(points={{-78,358},{-70,358},{
          -70,356},{-62,356},{-62,462},{-122,462}}, color={0,0,127}));
...
end FlexlabX1aNoLeakG36Baseline_test21;
