...
block TrimAndRespond2 "Block to inplement trim and respond logic"
...
equation
  ...
  connect(pro.y, minInp.u1)
    annotation (Line(points={{0,-100},{10,-100},{10,-114},{18,-114}},
      color={0,0,127}));
  ...
  connect(difReqIgnReq.y, pro.u1)
    annotation (Line(points={{-78,-30},{-40,-30},{-40,-94},{-24,-94}},
      color={0,0,127}));
  ...
  connect(abs.y, pro.u2)
    annotation (Line(points={{-98,-130},{-40,-130},{-40,-106},{-24,-106}},
      color={0,0,127}));
