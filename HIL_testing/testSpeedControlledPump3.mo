...
model testSpeedControlledPump3
...
equation
  ...
  connect(booleanConstant.y, opeModSel.uOcc) annotation (Line(points={{-31,76},
          {-8,76},{-8,70},{2,70}}, color={255,0,255}));
