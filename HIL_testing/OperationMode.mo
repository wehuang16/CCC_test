...
protected
  ...
  hil_flexlab_model.Test1.BaseClasses1.AddParameter addPar(final p=TZonFreProOn,
      final k=-1)
  ...
  hil_flexlab_model.Test1.BaseClasses1.AddParameter addPar1(final k=1, final p=
        (-1)*TZonFreProOff)
