...
model FlexlabX1aNoLeakG36Baseline_test221
...
//      ave(nin=3));
  ...
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant const4(final k=1.049)
    "Flow rate signal for heating coil when freeze stat is on"
    annotation (Placement(transformation(extent={{236,366},{256,386}})));
equation
  ...
  connect(const4.y, zonToSys.yAveOutAirFraPlu) annotation (Line(points={{258,
          376},{264,376},{264,388},{272,388},{272,432}}, color={0,0,127}));
  annotation (
...
end FlexlabX1aNoLeakG36Baseline_test221;
