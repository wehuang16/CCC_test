...
partial model PartialOpenLoopX1aNoLeakage_test0
...
equation
  ...
  connect(dpDisSupFan.port_b, amb.ports[3]) annotation (Line(
      ...
      color={0,0,0},
      pattern=LinePattern.Dot));
  connect(senRetFlo.port_b, TRet.port_a) annotation (Line(points={{340,140},{110,
          140}},               color={0,127,255}));
  ...
  connect(heaCoi.port_b1, sinHea.ports[1]) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(senSupFlo.port_b, dpRetDuc.port_a) annotation (Line(points={{420,-40},
          {656,-40},{656,140},{400,140}}, color={0,127,255}));
...
end PartialOpenLoopX1aNoLeakage_test0;
