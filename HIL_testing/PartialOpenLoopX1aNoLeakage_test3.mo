...
partial model PartialOpenLoopX1aNoLeakage_test3
...
equation
  ...
  connect(amb.ports[1], VOut1.port_a) annotation (Line(
      points={{-114,-46.1},{-94,-46.1},{-94,-33},{-72,-33}},
      color={0,127,255},
      smooth=Smooth.None,
      thickness=0.5));
  ...
  connect(VOut1.port_b, TMix.port_a) annotation (Line(points={{-50,-33},{-40,
          -33},{-40,-40},{30,-40}}, color={0,127,255}));
  connect(TRet.port_b, amb.ports[2]) annotation (Line(points={{90,140},{20,140},
          {20,136},{-102,136},{-102,-43.9},{-114,-43.9}}, color={0,127,255}));
...
end PartialOpenLoopX1aNoLeakage_test3;
