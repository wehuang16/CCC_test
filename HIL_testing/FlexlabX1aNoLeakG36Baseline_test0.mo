...
equation
  ...
  connect(integerConstant1.y, conAHU.uZonTemResReq) annotation (Line(points={{
          323,392},{336,392},{336,433.059},{356,433.059}}, color={255,127,0}));
  connect(integerConstant1.y, conAHU.uZonPreResReq) annotation (Line(points={{
          323,392},{336,392},{336,427.412},{356,427.412}}, color={255,127,0}));
  annotation (
