...
model MixedAir
  ...
  Buildings.ThermalZones.Detailed.MixedAir roo(
    ...
    annotation (Placement(transformation(extent={{48,20},{88,60}})));
...
equation
  ...
  connect(multiplex3_1.y, roo.qGai_flow) annotation (Line(
      points={{1,50},{22,50},{22,48},{46.4,48}},
      color={0,0,127},
      smooth=Smooth.None));

  connect(weaDat.weaBus, roo.weaBus) annotation (Line(
      points={{180,150},{190,150},{190,57.9},{85.9,57.9}},
      color={255,204,51},
      thickness=0.5,
      smooth=Smooth.None));
  ...
  connect(roo.surf_surBou, conOut.port_a) annotation (Line(
      points={{64.2,26},{62,26},{62,-50},{100,-50}},
      color={191,0,0},
      smooth=Smooth.None));
  connect(roo.uSha, replicator.y) annotation (Line(
      points={{46.4,58},{40,58},{40,100},{31,100}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(roo.ports[1], boundary.ports[1]) annotation (Line(
      points={{53,30},{34,30},{34,10},{20,10}},
      color={0,127,255},
      smooth=Smooth.None));
