...
package test_43
  ...
  parameter Real scalingFactor=6 "Scaling factor";
    ...
    Modelica.Blocks.Sources.Constant T_amb_internal(k=291.15)
      annotation (Placement(transformation(extent={{10,-10},{-10,10}},
          rotation=-90,
          origin={2,-76})));
    CCC_test.TRC_troubleshooting.test_43.HeatPumpAixlibModel heatPump(
...
<p>
  ...
  model HeatPumpAixlibModel
    ...
    extends
      CCC_test.TRC_troubleshooting.test_43.PartialReversibleVapourCompressionMachine(
      use_rev=true,
      machineType=true,
      redeclare CCC_test.TRC_troubleshooting.test_43.InnerCycle_HeatPump
        innerCycle(
        use_rev=use_rev,
        scalingFactor=scalingFactor,
    ...
    replaceable model PerDataMainHP =
        CCC_test.TRC_troubleshooting.test_43.HeatPumpPartialPerformanceData
    "Performance data of a heat pump in main operation mode"
      annotation (choicesAllMatching=true);
    replaceable model PerDataRevHP =
        CCC_test.TRC_troubleshooting.test_43.ChillerPartialPerformanceData
...
<ul>
  ...
  partial model PartialReversibleVapourCompressionMachine
    ...
    extends CCC_test.TRC_troubleshooting.test_43.PartialFourPortInterface(
  ...
  //General
    ...
    replaceable CCC_test.TRC_troubleshooting.test_43.PartialInnerCycle innerCycle
...
<ul>
  ...
  partial model PartialFourPortInterface
    ...
    extends CCC_test.TRC_troubleshooting.test_43.PartialFourPort;
...
are often iteration variables in nonlinear equation systems.
  ...
  model InnerCycle_HeatPump
    ...
    extends CCC_test.TRC_troubleshooting.test_43.PartialInnerCycle;
...
<ul>
  ...
  partial model HeatPumpPartialPerformanceData
...
<p>
  ...
  end HeatPumpPartialPerformanceData;

  partial model ChillerPartialPerformanceData
    "Model with a replaceable for different methods of data aggregation"
    Modelica.Blocks.Interfaces.RealOutput Pel(final unit="W", final displayUnit="kW")
                                                        "Electrical Power consumed by HP" annotation (Placement(
          transformation(
  ...
  end ChillerPartialPerformanceData;
end test_43;
