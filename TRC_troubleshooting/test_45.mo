   ...
   extends Modelica.Icons.Example;
    ...
    Modelica.Blocks.Sources.Constant T_amb_internal(k=291.15)
      annotation (Placement(transformation(extent={{10,-10},{-10,10}},
          rotation=-90,
          origin={2,-76})));
    CCC_test.TRC_troubleshooting.test_45.HeatPumpAixlibModel heatPump(
...
<p>
  ...
  model HeatPumpAixlibModel
    ...
    extends
      CCC_test.TRC_troubleshooting.test_45.PartialReversibleVapourCompressionMachine(
      use_rev=true,
      machineType=true,
      redeclare CCC_test.TRC_troubleshooting.test_45.InnerCycle_HeatPump innerCycle(
        use_rev=use_rev,
...
<ul>
  ...
  partial model PartialReversibleVapourCompressionMachine
    ...
    extends CCC_test.TRC_troubleshooting.test_45.PartialFourPortInterface(
  ...
  //General
    ...
    replaceable CCC_test.TRC_troubleshooting.test_45.PartialInnerCycle innerCycle constrainedby
      CCC_test.TRC_troubleshooting.test_45.PartialInnerCycle
...
<ul>
  ...
  partial model PartialFourPortInterface
    ...
    extends CCC_test.TRC_troubleshooting.test_45.PartialFourPort;
...
are often iteration variables in nonlinear equation systems.
  ...
  model InnerCycle_HeatPump
    ...
    extends CCC_test.TRC_troubleshooting.test_45.PartialInnerCycle;
