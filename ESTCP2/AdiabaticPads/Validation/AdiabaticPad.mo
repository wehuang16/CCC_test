within CCC_test.ESTCP2.AdiabaticPads.Validation;
model AdiabaticPad "Single adiabatic pad"
  ...
  package MediumPropyleneGlycol =
      Buildings.Media.Antifreeze.PropyleneGlycolWater (property_T=273.15+50, X_a=
            0.4);
  CCC_test.ESTCP2.AdiabaticPads.AdiabaticPad adiabaticPad1(
    redeclare package Medium = MediumAir,
    m_flow_nominal=1,
    redeclare CCC_test.ESTCP2.AdiabaticPads.Data.MfrA6inVersion1 per(efficiency(
          v={0,1.27,1.524,1.778,2.032,2.2352,2.5146,2.7686,3.0226,3.302,3.556,
            35.56,355.6}, eta={0.819,0.744,0.731,0.714,0.695,0.681,0.664,0.66,
            0.647,0.634,0.623,0.04973949,5.56788318e-13}), pressure(v={0,1.27,
            1.524,1.778,2.032,2.2352,2.5146,2.7686,3.0226,3.302,3.556,35.56,
            355.6}, dp={0,8.7094,11.1978,13.93504,17.66764,21.1514,26.87472,
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort temInt(redeclare package Medium =
        ...
        rotation=0,
        origin={26,-6})));
  CCC_test.ESTCP2.AdiabaticPads.AdiabaticPad adiabaticPad2(
    redeclare package Medium = MediumAir,
    m_flow_nominal=1,
    redeclare CCC_test.ESTCP2.AdiabaticPads.Data.MfrA6inVersion1 per)
