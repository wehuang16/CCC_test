...
model ArisWaterTankGroup
  ...
  Modelica.Thermal.HeatTransfer.Sensors.TemperatureSensor tempTanBot1
    annotation (Placement(transformation(
        ...
        rotation=0,
        origin={2,-208})));
  CCC.Controls.FlowConstraintBreaker flowConstraintBreaker annotation (
      Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=180,
        origin={-108,-234})));
equation
  ...
  connect(flowConstraintBreaker.port_a, jun1.port_2) annotation (Line(points={{
          -97.6,-235.6},{-64,-235.6},{-64,-226},{-58,-226}}, color={0,127,255}));
  annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-40,
            -300},{320,-40}})),                                  Diagram(
        coordinateSystem(preserveAspectRatio=false, extent={{-40,-300},{320,-40}})));
