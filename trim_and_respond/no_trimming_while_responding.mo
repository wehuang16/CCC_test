...
model no_trimming_while_responding
  ...
  hil_flexlab_model.Test1.BaseClasses1.Controls.SupplyTemperature
                                                ModelSatSetpoint1(
    final samplePeriod=180,
    final TSupSetMin=284.85,
    final TSupSetMax=291.45,
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput no_trimming_while_responding(unit="K", displayUnit="degC")
...
equation
  ...
  connect(const.y, ModelSatSetpoint1.TZonSetAve) annotation (Line(points={{-57,92},
          {22,92},{22,22},{18,22},{18,-32},{24,-32},{24,-38},{34,-38}}, color={0,
          0,127}));
  connect(integerConstant.y, ModelSatSetpoint1.uOpeMod) annotation (Line(points
        ={{-79,-72},{26,-72},{26,-70},{34,-70}}, color={255,127,0}));
  connect(booleanConstant.y, ModelSatSetpoint1.uSupFan) annotation (Line(points
        ={{-99,-32},{-50,-32},{-50,28},{14,28},{14,-58},{26,-58},{26,-62},{34,-62}},
        color={255,0,255}));
  connect(realToInteger.y, ModelSatSetpoint1.uZonTemResReq) annotation (Line(
        points={{-61,8},{12,8},{12,-56},{26,-56},{26,-54},{34,-54}}, color={255,
          127,0}));
  ...
  connect(OAT.y, ModelSatSetpoint1.TOut) annotation (Line(points={{-123,42},{16,
          42},{16,-34},{22,-34},{22,-46},{34,-46}}, color={0,0,127}));
  connect(SatRequests.y, realToInteger.u) annotation (Line(points={{-120,2},{-94,
          2},{-94,8},{-84,8}}, color={0,0,127}));
  connect(ModelSatSetpoint.TSupSet, have_trimming_while_responding) annotation (
     Line(points={{78,36},{104,36},{104,44},{120,44}}, color={0,0,127}));
  connect(ModelSatSetpoint1.TSupSet, no_trimming_while_responding) annotation (
      Line(points={{82,-54},{124,-54},{124,-48},{140,-48}}, color={0,0,127}));
...
end no_trimming_while_responding;
