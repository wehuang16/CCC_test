...
model FlexlabX1aNoLeakG36Baseline_test
...
//      ave(nin=3));
  ...
  Modelica.Blocks.Routing.BooleanReplicator                  booRep(final nout=numZon)
...
equation
  ...
  connect(booleanConstant1.y, conAHU.u_UnOcc) annotation (Line(points={{-245,
          ...
          255}));
  connect(booRep.y, TZonSet.uOcc) annotation (Line(points={{-125,326},{-125,
...
end FlexlabX1aNoLeakG36Baseline_test;
