...
model Hybrid_2024_v3_test2B
  ...
  CCC.Controls.FlowConstraintBreaker flowConstraintBreaker1(redeclare package
      Medium = MediumW)
...
equation
  ...
  connect(valA3.port_3, flowConstraintBreaker1.port_a) annotation (Line(points=
          {{-36.5,6},{-36.5,1.12},{-36.96,1.12},{-36.96,-3.76}}, color={0,127,
          255}));
  connect(flowConstraintBreaker1.port_b, pump.port_a) annotation (Line(points={
          {-36.96,-16},{-36.5,-17},{-36,-17},{-36,-40}}, color={0,127,255}));
