...
model AirHeating
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Pulse TSet(
    shift(displayUnit="h") = 21600,
    amplitude=6,
  ...
  Buildings.Controls.OBC.CDL.Continuous.Hysteresis sta1(uLow=0.05, uHigh=0.5)
    "Hysteresis to switch on stage 1"
    annotation (Placement(transformation(extent={{-80,-90},{-60,-70}})));
  Buildings.Controls.OBC.CDL.Conversions.BooleanToReal mSetFan1_flow(realTrue=
        mRec_flow_nominal/2) "Mass flow rate for 1st stage"
    annotation (Placement(transformation(extent={{-50,-90},{-30,-70}})));
  Buildings.Controls.OBC.CDL.Continuous.Hysteresis sta2(uLow=0.5, uHigh=0.75)
    "Hysteresis to switch on stage 2"
    annotation (Placement(transformation(extent={{-80,-60},{-60,-40}})));
  Buildings.Controls.OBC.CDL.Conversions.BooleanToReal mSetFan2_flow(realTrue=
        mRec_flow_nominal/2) "Mass flow rate added for 2nd stage"
    annotation (Placement(transformation(extent={{-50,-60},{-30,-40}})));
  Buildings.Controls.OBC.CDL.Continuous.Add m_fan_set "Mass flow rate for fan"
    annotation (Placement(transformation(extent={{8,-66},{28,-46}})));
  Buildings.Controls.OBC.CDL.Continuous.Add TAirLvgSet
    "Set point temperature for air leaving the heater"
    annotation (Placement(transformation(extent={{40,-90},{60,-70}})));
  Buildings.Controls.OBC.CDL.Continuous.AddParameter TSupMin(p=2)
  ...
  Buildings.Controls.OBC.CDL.Continuous.MultiplyByParameter gai(final k=8)
    "Gain factor"
