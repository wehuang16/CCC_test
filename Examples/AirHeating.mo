...
model AirHeating
  ...
  Buildings.Controls.OBC.CDL.Reals.Hysteresis sta1(uLow=0.05, uHigh=0.5)
  ...
  Buildings.Controls.OBC.CDL.Reals.Hysteresis sta2(uLow=0.5, uHigh=0.75)
  ...
  Buildings.Controls.OBC.CDL.Reals.Add m_fan_set "Mass flow rate for fan"
  ...
  Buildings.Controls.OBC.CDL.Reals.AddParameter TSupMin(p=2)
  ...
  Buildings.Controls.OBC.CDL.Reals.MultiplyByParameter gai(final k=8)
    "Gain factor"
