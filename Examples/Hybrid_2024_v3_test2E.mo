...
equation
  ...
  connect(const.y, hybrid_2024_controller.SOChotPCM) annotation (Line(points={{
        ...
        color={0,0,127}));
  connect(const.y, hybrid_2024_controller.SOCcoldPCM) annotation (Line(points={{-311,
          -30},{-290,-30},{-290,16},{-292,16},{-292,24.1333},{-284,24.1333}},
                     color={0,0,127}));
  ...
  connect(boundary4.ports[1], pump.port_a) annotation (Line(points={{-30,-13},{
          -30,-14},{-24,-14},{-24,-34},{-36,-34},{-36,-40}}, color={0,127,255}));
  connect(mFloRet1.port_b, boundary1.ports[1]) annotation (Line(points={{-76,16},
          {-192,16},{-192,27},{-198,27}}, color={0,127,255}));
  connect(booleanToReal1.y, pump.y) annotation (Line(points={{-209,-14},{-52,
          -14},{-52,-24},{-14,-24},{-14,-50},{-24,-50}}, color={0,0,127}));
