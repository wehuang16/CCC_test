...
equation
  ...
  connect(boundary.ports[1], hex.port_a2) annotation (Line(points={{36,-12},{16,
          -12},{16,-2},{12,-2}}, color={0,127,255}));
  annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
        coordinateSystem(preserveAspectRatio=false)));
end FanCoilUnitPidTest1A;
