...
//      ave(nin=3));
  ...
  hil_flexlab_model.Plants.Controls.Controller conVAVNor(
  ...
  hil_flexlab_model.Plants.Controls.Controller conVAVCor(
  ...
  hil_flexlab_model.Plants.Controls.Controller conVAVSou(
  ...
  hil_flexlab_model.Plants.Controls.OutdoorDamperPositionBlock outdoorDamperPositionBlock
