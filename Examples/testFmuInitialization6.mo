...
equation
  ...
  connect(add1.y, y) annotation (Line(points={{77,36},{96,36},{96,-2},{110,-2}},
        color={0,0,127}));
  connect(const2.y, realSwitch2_1.u1) annotation (Line(points={{-67,-38},{-20,
          -38},{-20,-49.8}}, color={0,0,127}));
  connect(const3.y, realSwitch2_1.u3) annotation (Line(points={{-63,-88},{-28,
          -88},{-28,-64.2},{-20.2,-64.2}}, color={0,0,127}));
  connect(u, realSwitch2_1.u2) annotation (Line(points={{-120,-2},{-94,-2},{-94,
          -57},{-20,-57}}, color={0,0,127}));
  connect(realSwitch2_1.y, y2) annotation (Line(points={{3,-55.8},{3,-54},{94,
          -54},{94,-48},{110,-48}}, color={0,0,127}));
  annotation (
