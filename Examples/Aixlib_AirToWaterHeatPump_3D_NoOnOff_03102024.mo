...
model Aixlib_AirToWaterHeatPump_3D_NoOnOff_03102024
...
equation
  ...
  connect(conPID.y, sigBus1.nSet) annotation (Line(points={{13,-62},{30,-62},{
          30,-66},{45.075,-66},{45.075,-16.915}}, color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
...
end Aixlib_AirToWaterHeatPump_3D_NoOnOff_03102024;
