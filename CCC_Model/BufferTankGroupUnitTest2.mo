...
parameter Integer numZon=54 "number of zones";
  ...
  Buildings.Controls.OBC.CDL.Routing.RealScalarReplicator    reaScaRep(nout=
    ...
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
        rotation=90,
        origin={40,-90})));
  TRC_1BufferTank_3fcus_fake3Pid tRC_1BufferTank_3fcus_fake3Pid[numApa](
...
*/
  ...
  connect(tRC_1BufferTank_3fcus_fake3Pid.port_a5, vol3.ports[2:3]) annotation (
      Line(points={{28,-25.8},{70,-25.8},{70,-6},{115.333,-6},{115.333,50}},
        color={0,127,255}));
  connect(pump2.port_a, vol4.ports[1]) annotation (Line(points={{86,-124},{44,
          -124},{44,-144},{26.6667,-144},{26.6667,-138}}, color={0,127,255}));
  connect(tRC_1BufferTank_3fcus_fake3Pid.port_b5, vol4.ports[2:3]) annotation (
      Line(points={{28,-58.2},{2,-58.2},{2,-138},{29.3333,-138}}, color={0,127,
          255}));
  connect(booScaRep.y, tRC_1BufferTank_3fcus_fake3Pid.heaCooMod) annotation (
      Line(points={{-12,-62},{0,-62},{0,-39.8},{17.6,-39.8}}, color={255,0,255}));
  ...
  connect(tRC_1BufferTank_3fcus_fake3Pid.RequestSpaCon,
    multipleHeatPumpZoneController.reqSpaCon) annotation (Line(points={{59.4,
          -60},{59.4,-68},{-4,-68},{-4,-78},{-140,-78},{-140,-42.6},{-130.2,
