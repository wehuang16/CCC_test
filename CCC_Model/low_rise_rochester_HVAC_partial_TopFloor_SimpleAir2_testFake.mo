...
model low_rise_rochester_HVAC_partial_TopFloor_SimpleAir2_testFake
...
parameter Integer numZon=54 "number of zones";
  ...
  CCC.Fluid.BaseClasses.low_rise_rochester_designbuilder_fake
                                      low_rise_rochester_designbuilder_fake
...
equation
  ...
  connect(low_rise_rochester_designbuilder_fake.TOut, reaScaRep.u) annotation (
      Line(points={{25.8,19.2},{25.8,24},{84,24},{84,-102},{40,-102}}, color={0,
          0,127}));
  connect(low_rise_rochester_designbuilder_fake.TOut, trc_heat_pump_group.TOutAir)
  ...
  connect(low_rise_rochester_designbuilder_fake.TAir[38:40],
  ...
  connect(low_rise_rochester_designbuilder_fake.TAir[41:43],
  ...
  connect(low_rise_rochester_designbuilder_fake.TAir[44:46],
    tRC_1BufferTank_3fcus_SimpleConstantAir[3].TZoneAir) annotation (Line(
        points={{38,3.25455},{46,3.25455},{46,6},{45.8,6},{45.8,-24.8}}, color=
          {0,0,127}));

  connect(low_rise_rochester_designbuilder_fake.TAir[47:49],
    tRC_1BufferTank_3fcus_SimpleConstantAir[4].TZoneAir) annotation (Line(
        points={{38,3.36364},{46,3.36364},{46,6},{45.8,6},{45.8,-24.8}}, color=
          {0,0,127}));

  connect(low_rise_rochester_designbuilder_fake.TAir[50:52],
    tRC_1BufferTank_3fcus_SimpleConstantAir[5].TZoneAir) annotation (Line(
        points={{38,3.47273},{46,3.47273},{46,6},{45.8,6},{45.8,-24.8}}, color=
          {0,0,127}));

  connect(low_rise_rochester_designbuilder_fake.TAir[53:55],
    tRC_1BufferTank_3fcus_SimpleConstantAir[6].TZoneAir) annotation (Line(
        points={{38,3.58182},{46,3.58182},{46,6},{45.8,6},{45.8,-24.8}}, color=
          {0,0,127}));

  connect(low_rise_rochester_designbuilder_fake.port_b[38:40],
  ...
  connect(low_rise_rochester_designbuilder_fake.port_b[41:43],
  ...
  connect(low_rise_rochester_designbuilder_fake.port_b[44:46],
  ...
  connect(low_rise_rochester_designbuilder_fake.port_b[47:49],
  ...
  connect(low_rise_rochester_designbuilder_fake.port_b[50:52],
  ...
  connect(low_rise_rochester_designbuilder_fake.port_b[53:55],
    tRC_1BufferTank_3fcus_SimpleConstantAir[6].port_a) annotation (Line(points=
          {{36.4,16.2909},{56,16.2909},{56,-8},{14,-8},{14,-31.4},{19.4,-31.4}},
        color={0,127,255}));

  connect(low_rise_rochester_designbuilder_fake.port_a[38:40],
  ...
  connect(low_rise_rochester_designbuilder_fake.port_a[41:43],
  ...
  connect(low_rise_rochester_designbuilder_fake.port_a[44:46],
  ...
  connect(low_rise_rochester_designbuilder_fake.port_a[47:49],
  ...
  connect(low_rise_rochester_designbuilder_fake.port_a[50:52],
  ...
  connect(low_rise_rochester_designbuilder_fake.port_a[53:55],
    tRC_1BufferTank_3fcus_SimpleConstantAir[6].port_b) annotation (Line(points=
          {{15.6,16.2909},{8,16.2909},{8,-12},{74,-12},{74,-31.4},{68.6,-31.4}},
        color={0,127,255}));
  connect(low_rise_rochester_designbuilder_fake.port_b[2:37],
    trc_custom_air_conditioner.port_a) annotation (Line(points={{36.4,15.9636},
          {112,15.9636},{112,20.6},{117.6,20.6}}, color={0,127,255}));
  connect(trc_custom_air_conditioner.port_b,
    low_rise_rochester_designbuilder_fake.port_a[2:37]) annotation (Line(points
        ={{138.8,20.4},{148,20.4},{148,22},{15.6,22},{15.6,15.9636}}, color={0,
          127,255}));
  connect(low_rise_rochester_designbuilder_fake.TAir[2:37],
    trc_custom_air_conditioner.ZAT) annotation (Line(points={{38,2.92727},{46,
          2.92727},{46,20},{108,20},{108,34.4},{116,34.4}}, color={0,0,127}));
...
end low_rise_rochester_HVAC_partial_TopFloor_SimpleAir2_testFake;
