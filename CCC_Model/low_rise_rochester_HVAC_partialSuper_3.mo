...
model low_rise_rochester_HVAC_partialSuper_3
...
parameter Integer numZon=54 "number of zones";
  ...
  TRC_1BufferTank_3fcus_fake                  tRC_1BufferTank_3fcus_fake
                                                                   [numApa](
...
equation
  ...
  connect(tRC_1BufferTank_3fcus_fake.port_a5, vol3.ports[2:numApa + 1])
    annotation (Line(points={{28,-25.8},{30,-25.8},{30,-18},{-10,-18},{-10,-26}},
        color={0,127,255}));
  connect(tRC_1BufferTank_3fcus_fake.port_b5, vol4.ports[2:numApa + 1])
    annotation (Line(points={{28,-58.2},{28,-62},{-192,-62},{-192,-16}}, color={
          0,127,255}));
  connect(booScaRep.y, tRC_1BufferTank_3fcus_fake.heaCooMod) annotation (Line(
        points={{-30,-44},{8,-44},{8,-39.8},{17.6,-39.8}}, color={255,0,255}));
  connect(reaScaRep.y, tRC_1BufferTank_3fcus_fake.TOut) annotation (Line(points
        ={{40,-78},{40,-66},{44.8,-66},{44.8,-60}}, color={0,0,127}));
  connect(tRC_1BufferTank_3fcus_fake.RequestSpaCon,
  ...
  connect(low_rise_rochester_designbuilder.TAir[2:4],
    tRC_1BufferTank_3fcus_fake[1].TZoneAir) annotation (Line(points={{38,1.72727},
          {46,1.72727},{46,6},{45.8,6},{45.8,-24.8}}, color={0,0,127}));

  connect(low_rise_rochester_designbuilder.TAir[5:7],
    tRC_1BufferTank_3fcus_fake[2].TZoneAir) annotation (Line(points={{38,1.83636},
          {46,1.83636},{46,6},{45.8,6},{45.8,-24.8}}, color={0,0,127}));
/*
...
*/
  connect(low_rise_rochester_designbuilder.port_b[2:4],
    tRC_1BufferTank_3fcus_fake[1].port_a) annotation (Line(points={{36.4,
          15.3636},{56,15.3636},{56,-8},{14,-8},{14,-31.4},{19.4,-31.4}},
                                                                 color={0,127,255}));

  connect(low_rise_rochester_designbuilder.port_b[5:7],
    tRC_1BufferTank_3fcus_fake[2].port_a) annotation (Line(points={{36.4,
...
annotation (Line(points={{36.4,16.2909},{56,16.2909},{56,-8},{14,-8},{14,-31.4},
  ...
  connect(low_rise_rochester_designbuilder.port_a[2:4],
    tRC_1BufferTank_3fcus_fake[1].port_b) annotation (Line(points={{15.6,
          15.3636},{8,15.3636},{8,-12},{74,-12},{74,-31.4},{68.6,-31.4}},
                                                                 color={0,127,255}));

  connect(low_rise_rochester_designbuilder.port_a[5:7],
    tRC_1BufferTank_3fcus_fake[2].port_b) annotation (Line(points={{15.6,
...
end low_rise_rochester_HVAC_partialSuper_3;
