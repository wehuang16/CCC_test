...
model CccHpTesSystem_v5
  ...
  package MediumWater = Buildings.Media.Water;
    package MediumPropyleneGlycol =
      Buildings.Media.Antifreeze.PropyleneGlycolWater (property_T=273.15+50, X_a=
            0.4);
  IBPSA.Fluid.Sources.Boundary_pT DhwSink(redeclare package Medium =
        MediumWater, nPorts=1) annotation (Placement(transformation(
        extent={{10,-10},{-10,10}},
        rotation=90,
        origin={146,92})));
  HeatExchangers.BaseClasses.CoilRegisterFourPort phaseChangeBattery58(
    m1_flow_nominal=1,
    m2_flow_nominal=1,
    ...
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
        rotation=90,
        origin={54,-18})));
  HeatExchangers.Data.MAPR            matPro(TSolPas=302.15, TLiqPas=304.15)
    annotation (Placement(transformation(extent={{-80,80},{-60,100}})));
  HeatExchangers.BaseClasses.CoilRegisterFourPort phaseChangeBattery48(
    m1_flow_nominal=1,
    m2_flow_nominal=1,
    Design(Tes_nominal(displayUnit="kWh") = 14400000, PCM(
        k=matPro.kPCMLow,
    ...
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
        rotation=90,
        origin={56,-64})));
  HeatExchangers.BaseClasses.CoilRegisterFourPort phaseChangeBattery30(
    m1_flow_nominal=1,
    m2_flow_nominal=1,
    Design(Tes_nominal(displayUnit="kWh") = 14400000, PCM(
        k=matPro.kPCMPas,
  ...
  IBPSA.Fluid.Sources.MassFlowSource_T
                                  sou(redeclare package Medium = MediumWater,
    use_m_flow_in=true,
    m_flow=0.1,
    T=285.15,
      nPorts=1) annotation (Placement(transformation(
        ...
        rotation=0,
        origin={186,60})));
  Buildings.Fluid.FixedResistances.Junction divergingJun(
    redeclare package Medium = MediumWater,
  ...
  Buildings.Fluid.Actuators.Valves.ThreeWayLinear val1(
    ...
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
        rotation=90,
        origin={76,16})));
  Buildings.Fluid.FixedResistances.Junction divergingJun1(
    redeclare package Medium = MediumWater,
    m_flow_nominal={2,-1,-1},
    dp_nominal={0,0,0})   annotation (Placement(transformation(
        extent={{-11,11},{11,-11}},
  ...
  Buildings.Fluid.Movers.FlowControlled_m_flow fan(redeclare package Medium =
    ...
    annotation (Placement(transformation(extent={{-168,14},{-148,34}})));
  Buildings.Fluid.HeatExchangers.DryCoilCounterFlow heaCoi(
    redeclare package Medium1 = MediumWater,
    redeclare package Medium2 = MediumWater,
    m1_flow_nominal=0.92,
    m2_flow_nominal=1,
    dp1_nominal=1,
    dp2_nominal=1,
    UA_nominal=1500)
  ...
  Buildings.Fluid.HeatExchangers.HeaterCooler_u
    ...
    dp_nominal=0,
    Q_flow_nominal=5000)
    annotation (Placement(transformation(extent={{-190,-148},{-170,-128}})));
  HeatPumps.Aixlib_AirToWaterHeatPump_3D aixlib_AirToWaterHeatPump_3D(
      redeclare package Medium_eva = MediumAir, redeclare package Medium_con =
        MediumWater)
    annotation (Placement(transformation(extent={{-258,4},{-238,24}})));
  Controls.FlowConstraintBreaker flowConstraintBreaker(redeclare package Medium =
        MediumWater) annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=180,
        origin={-212,76})));
  ...
  Buildings.Fluid.FixedResistances.Junction convergingJun(
    ...
    dp_nominal={0,0,0})   annotation (Placement(transformation(
        ...
        rotation=180,
        origin={-88,12})));
  Buildings.Fluid.FixedResistances.Junction convergingJun1(
    redeclare package Medium = MediumWater,
    m_flow_nominal={1,-2,1},
    dp_nominal={0,0,0})   annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={-88,-54})));
  Buildings.Fluid.FixedResistances.Junction divergingJun2(
    redeclare package Medium = MediumWater,
    m_flow_nominal={2,-1,-1},
    dp_nominal={0,0,0})   annotation (Placement(transformation(
        extent={{-11,11},{11,-11}},
        rotation=0,
        origin={-109,-139})));
  Buildings.Fluid.FixedResistances.Junction divergingJun3(
    redeclare package Medium = MediumWater,
    m_flow_nominal={2,-1,-1},
    dp_nominal={0,0,0})   annotation (Placement(transformation(
        extent={{-11,11},{11,-11}},
        rotation=0,
        origin={-11,-141})));
  Controls.FlowConstraintBreaker flowConstraintBreaker1(redeclare package
  ...
  Modelica.Blocks.Sources.Constant const1(k=273.15 + 7)
    annotation (Placement(transformation(extent={{-158,-18},{-178,2}})));
  ...
  Modelica.Blocks.Sources.Constant const8(k=0.1)
    annotation (Placement(transformation(extent={{-192,44},{-172,64}})));
  ...
  Controls.ER_Controller eR_Controller
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
        rotation=-90,
        origin={-180,-106})));
  Controls.modular_SOC_Manager_with_HPSP modular_SOC_Manager_with_HPSP(
    numTES=numTES,
    expr={matPro.TLiqHig + 4,matPro.TLiqLow + 4,matPro.TLiqPas + 4},
    HPSP_default=matPro.TLiqPas)
    annotation (Placement(transformation(extent={{-10,-8},{10,8}},
        rotation=-90,
        origin={82,-134})));
  Modelica.Blocks.Math.BooleanToReal booleanToReal[numTES](realTrue=0.03,
      realFalse=0)
    annotation (Placement(transformation(extent={{170,-102},{150,-82}})));
  parameter Integer numTES=3;
equation
  connect(phaseChangeBattery30.port_b2, phaseChangeBattery48.port_a2)
    annotation (Line(points={{60.2,-120},{74,-120},{74,-54},{60.2,-54}},
                             color={0,127,255}));
  connect(sou.ports[1], divergingJun.port_1)
    annotation (Line(points={{176,60},{176,62},{138,62},{138,56}},
                                               color={0,127,255}));
  connect(divergingJun.port_2, phaseChangeBattery30.port_a2) annotation (Line(
        points={{138,36},{138,-100},{60.2,-100}},color={0,127,255}));
  connect(divergingJun.port_3, val.port_3) annotation (Line(points={{128,46},{126,
          46},{126,48},{86,48}},color={0,127,255}));
  connect(phaseChangeBattery58.port_a2, divergingJun1.port_3) annotation (Line(
        points={{58.2,-8},{58.2,-9},{90,-9}},                       color={0,
          127,255}));
  connect(phaseChangeBattery48.port_b2, divergingJun1.port_1) annotation (Line(
        points={{60.2,-74},{60.2,-80},{101,-80},{101,-20}},
        color={0,127,255}));
  connect(DhwSink.ports[1], temp1.port_b)
    annotation (Line(points={{146,82},{146,74},{124,74}},
                                                       color={0,127,255}));
  connect(temp1.port_a, val.port_2)
    annotation (Line(points={{104,74},{76,74},{76,58}},color={0,127,255}));
  connect(fan.port_b, heaCoi.port_a1) annotation (Line(points={{-148,24},{-128,24}},
                                    color={0,127,255}));
  connect(flowConstraintBreaker.port_b, aixlib_AirToWaterHeatPump_3D.port_a)
    annotation (Line(points={{-222,74.4},{-236,74.4},{-236,30},{-264,30},{-264,21},
          {-259,21}},     color={0,127,255}));
  connect(fan3.port_a, phaseChangeBattery30.port_b1) annotation (Line(points={{-22,
          -100},{40,-100},{40,-94},{51.8,-94},{51.8,-100}},
                                                     color={0,127,255}));
  connect(fan2.port_a, phaseChangeBattery48.port_b1) annotation (Line(points={{-24,-54},
          {40,-54},{40,-48},{51.8,-48},{51.8,-54}}, color={0,127,255}));
  connect(fan1.port_a, phaseChangeBattery58.port_b1) annotation (Line(points={{-26,12},
          {49.8,12},{49.8,-8}},                               color={0,127,255}));
  connect(fan2.port_b, convergingJun1.port_3) annotation (Line(points={{-44,-54},
          {-78,-54}},           color={0,127,255}));
  connect(fan3.port_b, convergingJun1.port_1) annotation (Line(points={{-42,
          -100},{-88,-100},{-88,-64}},    color={0,127,255}));
  connect(convergingJun1.port_2, convergingJun.port_3) annotation (Line(points={{-88,-44},
          {-88,2}},                                            color={0,127,255}));
  connect(fan1.port_b, convergingJun.port_1) annotation (Line(points={{-46,12},
          {-62,12},{-62,12},{-78,12}},   color={0,127,255}));
  connect(convergingJun.port_2, heaCoi.port_a2) annotation (Line(points={{-98,12},
          {-108,12}},                           color={0,127,255}));
  connect(hea.port_b, divergingJun2.port_1) annotation (Line(points={{-170,-138},
          {-145,-138},{-145,-139},{-120,-139}},
                                             color={0,127,255}));
  connect(divergingJun2.port_2, divergingJun3.port_1) annotation (Line(points={{-98,
          -139},{-98,-141},{-22,-141}},
                  color={0,127,255}));
  connect(divergingJun2.port_3, phaseChangeBattery58.port_a1) annotation (Line(
        points={{-109,-128},{-110,-128},{-110,-28},{49.8,-28}},
                                                              color={0,127,255}));
  connect(divergingJun3.port_3, phaseChangeBattery48.port_a1) annotation (Line(
        points={{-11,-130},{-12,-130},{-12,-82},{51.8,-82},{51.8,-74}},
                                 color={0,127,255}));
  connect(divergingJun3.port_2, phaseChangeBattery30.port_a1) annotation (Line(
        points={{0,-141},{0,-142},{51.8,-142},{51.8,-120}},
                                color={0,127,255}));
  connect(heaCoi.port_b2, flowConstraintBreaker1.port_a) annotation (Line(
        points={{-128,12},{-142,12},{-142,-39.6},{-157.6,-39.6}},
                                                                color={0,127,
          255}));
  connect(booleanConstant.y, aixlib_AirToWaterHeatPump_3D.OnOff) annotation (
      Line(points={{-277,50},{-266,50},{-266,16},{-259.2,16}}, color={255,0,255}));
  connect(booleanConstant.y, aixlib_AirToWaterHeatPump_3D.Mode) annotation (
      Line(points={{-277,50},{-266,50},{-266,28},{-236.8,28},{-236.8,16}},
                                  color={255,0,255}));
  connect(const1.y, aixlib_AirToWaterHeatPump_3D.TOutAir) annotation (Line(
        points={{-179,-8},{-188,-8},{-188,10.7},{-236.7,10.7}},   color={0,0,
          127}));
  connect(phaseChangeBattery58.port_b2, val1.port_1) annotation (Line(points={{58.2,
          -28},{58.2,-34},{76,-34},{76,6}},                      color={0,127,
          255}));
  connect(divergingJun1.port_2, val1.port_3)
    annotation (Line(points={{101,2},{101,16},{86,16}},  color={0,127,255}));
  connect(const5.y, val1.y) annotation (Line(points={{15,62},{42,62},{42,16},{64,
          16}},                    color={0,0,127}));
  connect(val1.port_2, val.port_1) annotation (Line(points={{76,26},{76,38}},
                        color={0,127,255}));
  connect(const6.y, val.y) annotation (Line(points={{33,94},{54,94},{54,48},{64,
          48}},                                 color={0,0,127}));
  connect(hotWaterUse.y[1], UnitConversion.u) annotation (Line(points={{210,-33},
          {210,-16}},                   color={0,0,127}));
  connect(UnitConversion.y, sou.m_flow_in) annotation (Line(points={{210,7},{210,
          68},{198,68}},              color={0,0,127}));
  connect(aixlib_AirToWaterHeatPump_3D.port_b, tempHpSupply.port_a) annotation (
     Line(points={{-237.2,20.8},{-223.6,20.8},{-223.6,24},{-206,24}}, color={0,
          127,255}));
  connect(tempHpSupply.port_b, fan.port_a) annotation (Line(points={{-186,24},{-168,
          24}},                          color={0,127,255}));
  connect(heaCoi.port_b1, tempHpReturn.port_a) annotation (Line(points={{-108,24},
          {-108,74},{-140,74}},                 color={0,127,255}));
  connect(tempHpReturn.port_b, flowConstraintBreaker.port_a) annotation (Line(
        points={{-160,74},{-180.8,74},{-180.8,74.4},{-201.6,74.4}}, color={0,
          127,255}));
  connect(const8.y, fan.m_flow_in) annotation (Line(points={{-171,54},{-158,54},
          {-158,36}},                                         color={0,0,127}));
  connect(flowConstraintBreaker1.port_b, temperature.port_a) annotation (Line(
        points={{-178,-39.6},{-189,-39.6},{-189,-40},{-200,-40}}, color={0,127,
          255}));
  connect(temperature.port_b, hea.port_a) annotation (Line(points={{-220,-40},{-222,
          -40},{-222,-138},{-190,-138}},    color={0,127,255}));
  connect(temperature.T, eR_Controller.T_sys) annotation (Line(points={{-210,-51},
          {-198,-51},{-198,-88},{-186,-88},{-186,-94}},
                                  color={0,0,127}));
  connect(eR_Controller.ER_set, hea.u) annotation (Line(points={{-180,-118},{-200,
          -118},{-200,-132},{-192,-132}},   color={0,0,127}));
  connect(aixlib_AirToWaterHeatPump_3D.nSet, eR_Controller.HP_nSet) annotation (
     Line(points={{-236.7,5.5},{-190,5.5},{-190,-70},{-173.8,-70},{-173.8,-94}},
        color={0,0,127}));
  connect(phaseChangeBattery58.SOC,modular_SOC_Manager_with_HPSP.SOC_val[1]) annotation (
     Line(points={{63,-7},{62,-7},{62,-8},{82,-8},{82,-48},{81.1333,-48},{
          81.1333,-121.7}},
        color={0,0,127}));
  connect(phaseChangeBattery48.SOC,modular_SOC_Manager_with_HPSP.SOC_val[2]) annotation (
     Line(points={{65,-53},{65,-48},{81.9,-48},{81.9,-121.7}},
        color={0,0,127}));
  connect(phaseChangeBattery30.SOC,modular_SOC_Manager_with_HPSP.SOC_val[3]) annotation (
     Line(points={{65,-99},{65,-94},{82.6667,-94},{82.6667,-121.7}},
        color={0,0,127}));
  connect(modular_SOC_Manager_with_HPSP.SOC_bool, booleanToReal.u) annotation (
      Line(points={{82.1,-146.1},{82.1,-156},{182,-156},{182,-92},{172,-92}},
        color={255,0,255}));
  connect(modular_SOC_Manager_with_HPSP.HPsetpoint,
    aixlib_AirToWaterHeatPump_3D.TSupSet) annotation (Line(points={{75.8,-145.8},
          {75.8,-158},{-262,-158},{-262,10.1},{-259.1,10.1}}, color={0,0,127}));
  connect(modular_SOC_Manager_with_HPSP.HPsetpoint, eR_Controller.HP_setpoint)
    annotation (Line(points={{75.8,-145.8},{75.8,-158},{-164,-158},{-164,-86},{
          -180,-86},{-180,-93.8}}, color={0,0,127}));
  connect(booleanToReal[1].y, fan1.m_flow_in) annotation (Line(points={{149,-92},
          {-18,-92},{-18,-8},{-36,-8},{-36,1.77636e-15}}, color={0,0,127}));
  connect(booleanToReal[2].y, fan2.m_flow_in) annotation (Line(points={{149,-92},
          {-18,-92},{-18,-74},{-34,-74},{-34,-66}}, color={0,0,127}));
  connect(booleanToReal[3].y, fan3.m_flow_in) annotation (Line(points={{149,-92},
          {-18,-92},{-18,-120},{-32,-120},{-32,-112}}, color={0,0,127}));
  annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-300,-160},
            {220,100}})),                                        Diagram(
        coordinateSystem(preserveAspectRatio=false, extent={{-300,-160},{220,100}})),
    experiment(
      StopTime=604800,
      Interval=59.9999616,
      __Dymola_Algorithm="Dassl"));
end CccHpTesSystem_v5;
