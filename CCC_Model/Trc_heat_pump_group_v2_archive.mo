...
model Trc_heat_pump_group_v2_archive
...
equation
  ...
  connect(booToRea.y, mov.m_flow_in) annotation (Line(points={{158,64},{166,64},
          {166,80},{104,80},{104,70},{96,70},{96,64},{94,64},{94,34},{112,34},{
          112,30},{120,30}}, color={0,0,127}));
...
end Trc_heat_pump_group_v2_archive;
