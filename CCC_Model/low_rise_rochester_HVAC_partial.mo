...
model low_rise_rochester_HVAC_partial
  ...
  package MediumWater = Buildings.Media.Water;
    package MediumPropyleneGlycol =
      Buildings.Media.Antifreeze.PropyleneGlycolWater (property_T=273.15+50, X_a=
            0.4);
   parameter Integer numHeaPum=4 "number of heat pumps";
...
parameter Integer numZon=54 "number of zones";
  ...
  Buildings.Controls.OBC.CDL.Routing.RealScalarReplicator    reaScaRep(nout=
    ...
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
        rotation=90,
        origin={40,-90})));
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant conRea1[24](k={0,0,0,0,0,0,
  ...
  CCC.Fluid.BaseClasses.Trc_custom_air_conditioner trc_custom_air_conditioner[
    36] annotation (Placement(transformation(extent={{118,18},{138,38}})));
  ...
  Buildings.Controls.OBC.CDL.Integers.Sources.Constant conInt(k=0)
    "Real inputs"
    annotation (Placement(transformation(extent={{-214,20},{-194,40}})));
equation
...
connect(low_rise_rochester_designbuilder.TAir[38:40], tRC_1BufferTank_3fcus[1].TZoneAir)
annotation (Line(points={{38,3.03636},{46,3.03636},{46,6},{45.8,6},{45.8,-24.8}},
color={0,0,127}));

connect(low_rise_rochester_designbuilder.TAir[41:43], tRC_1BufferTank_3fcus[2].TZoneAir)
annotation (Line(points={{38,3.14545},{46,3.14545},{46,6},{45.8,6},{45.8,-24.8}},
color={0,0,127}));
...
connect(low_rise_rochester_designbuilder.port_b[38:40], tRC_1BufferTank_3fcus[1].port_a)
annotation (Line(points={{36.4,16.0182},{56,16.0182},{56,-8},{14,-8},{14,-31.4},
          {19.4,-31.4}},
               color={0,127,255}));

connect(low_rise_rochester_designbuilder.port_b[41:43], tRC_1BufferTank_3fcus[2].port_a)
annotation (Line(points={{36.4,16.0727},{56,16.0727},{56,-8},{14,-8},{14,-31.4},
          {19.4,-31.4}},
               color={0,127,255}));
...
connect(low_rise_rochester_designbuilder.port_a[38:40], tRC_1BufferTank_3fcus[1].port_b)
annotation (Line(points={{15.6,16.0182},{8,16.0182},{8,-12},{74,-12},{74,-31.4},
          {68.6,-31.4}},
               color={0,127,255}));

connect(low_rise_rochester_designbuilder.port_a[41:43], tRC_1BufferTank_3fcus[2].port_b)
annotation (Line(points={{15.6,16.0727},{8,16.0727},{8,-12},{74,-12},{74,-31.4},
          {68.6,-31.4}},
               color={0,127,255}));
...
annotation (Line(points={{15.6,16.2909},{8,16.2909},{8,-12},{74,-12},{74,-31.4},
  ...
  connect(low_rise_rochester_designbuilder.port_a[2:37],
    trc_custom_air_conditioner.port_b) annotation (Line(points={{15.6,15.9636},
...
end low_rise_rochester_HVAC_partial;
