...
model Aixlib_AirToWaterHeatPump_3D_v2
...
equation
  ...
  connect(add.y, gain.u) annotation (Line(points={{-23,94},{-14,94},{-14,84},{
          -6,84}}, color={0,0,127}));
  connect(gain.y, switch1.u3) annotation (Line(points={{17,84},{28,84},{28,94},
          {36,94}}, color={0,0,127}));
  connect(add.y, switch1.u1) annotation (Line(points={{-23,94},{-8,94},{-8,110},
          {36,110}}, color={0,0,127}));
  connect(add.u1, TWatRet.T)
    annotation (Line(points={{-46,100},{-64,100},{-64,65}}, color={0,0,127}));
  connect(add.u2, TWatSup.T) annotation (Line(points={{-46,88},{-10,88},{-10,60},
          {66,60},{66,67}}, color={0,0,127}));
...
end Aixlib_AirToWaterHeatPump_3D_v2;
