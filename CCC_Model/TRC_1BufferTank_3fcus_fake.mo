...
model TRC_1BufferTank_3fcus_fake
...
parameter Modelica.Units.SI.MassFlowRate fcu_air_flow_nominal=0.14951;
  ...
  FanCoilUnit_fake                     fanCoilUnit_fake                  [3](
  ...
  Modelica.Blocks.Sources.Constant const(k=273.15 + 40)
    annotation (Placement(transformation(extent={{354,-376},{374,-356}})));
  Modelica.Blocks.Sources.Constant const1(k=273.15 + 10)
    annotation (Placement(transformation(extent={{524,-390},{544,-370}})));
equation
  ...
  connect(pump.port_b, fanCoilUnit_fake.port_a1) annotation (Line(points={{398,
          30},{398,-68},{525.8,-68},{525.8,54.4}}, color={0,127,255}));
  connect(fanCoilUnit_fake.m_flow_water, pump.m_flow_in) annotation (Line(
        points={{547.2,58.2},{547.2,-72},{388,-72},{388,42}}, color={0,0,127}));
  connect(TZoneAir, fanCoilUnit_fake.TZon) annotation (Line(points={{418,-88},{
          418,-104},{496,-104},{496,-70},{540.4,-70},{540.4,38}}, color={0,0,
          127}));
  connect(tan.port_b, fanCoilUnit_fake[1].port_b1) annotation (Line(points={{
          314,-116},{314,-118},{316,-118},{316,-128},{382,-128},{382,-68},{
          546.2,-68},{546.2,54.4}}, color={0,127,255}));
  connect(tan.port_b, fanCoilUnit_fake[2].port_b1) annotation (Line(points={{
          314,-116},{314,-118},{316,-118},{316,-128},{382,-128},{382,-68},{
          546.2,-68},{546.2,54.4}}, color={0,127,255}));
  connect(tan.port_b, fanCoilUnit_fake[3].port_b1) annotation (Line(points={{
          314,-116},{314,-118},{316,-118},{316,-128},{382,-128},{382,-68},{
          546.2,-68},{546.2,54.4}}, color={0,127,255}));
  connect(port_a, fanCoilUnit_fake.port_a2) annotation (Line(points={{154,-154},
          {300,-154},{300,-150},{592,-150},{592,44.8},{546.2,44.8}}, color={0,
          127,255}));
  connect(fan.port_a, fanCoilUnit_fake.port_b2) annotation (Line(points={{454,
          18},{450,18},{450,28},{446,28},{446,45},{525.8,45}}, color={0,127,255}));
  connect(fan.port_b, port_b) annotation (Line(points={{474,18},{576,18},{576,
          24},{646,24},{646,-154}}, color={0,127,255}));
  connect(fan.m_flow_in, fanCoilUnit_fake.m_flow_air) annotation (Line(points={
          {464,30},{570,30},{570,41.8},{547.2,41.8}}, color={0,0,127}));
  connect(fanCoilUnit_fake.FcuMode, bufferTankModeController2_1.ModeFcu)
    annotation (Line(points={{528.8,38},{530,38},{530,28},{618,28},{618,60},{
  ...
  connect(logSwi1.y, booToRea.u) annotation (Line(points={{352,-286},{360,-286},
        ...
        color={255,0,255}));
  connect(const.y, switch1.u1) annotation (Line(points={{375,-366},{375,-368},{
          388,-368},{388,-344},{428,-344},{428,-352},{438,-352},{438,-342}},
        color={0,0,127}));
  connect(les.u2, const.y) annotation (Line(points={{396,-304},{396,-344},{388,
          -344},{388,-366},{375,-366}}, color={0,0,127}));
  connect(switch1.u3, const1.y) annotation (Line(points={{454,-342},{502,-342},
          {502,-354},{545,-354},{545,-380}}, color={0,0,127}));
  connect(const1.y, gre.u2) annotation (Line(points={{545,-380},{544,-380},{544,
          -356},{504,-356},{504,-304},{508,-304},{508,-294}}, color={0,0,127}));
  annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{160,
        ...
        coordinateSystem(preserveAspectRatio=false, extent={{160,-420},{640,
            -100}})));
end TRC_1BufferTank_3fcus_fake;
