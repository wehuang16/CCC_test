...
model FullPlantCalibration_archived_11132025
  Chiller_Storage_CoolingTower_ParallelChillerWithCustomControl
  ...
  Modelica.Blocks.Sources.CombiTimeTable dataTes(
    ...
    fileName=ModelicaServices.ExternalReferences.loadResource(
        "modelica://CCC_test/Resources/TES_trend_updated.txt"),
    columns=2:21,
...
end FullPlantCalibration_archived_11132025;
