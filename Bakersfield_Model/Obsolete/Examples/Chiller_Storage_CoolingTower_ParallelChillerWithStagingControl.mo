within CCC_test.Bakersfield_Model.Obsolete.Examples;
model Chiller_Storage_CoolingTower_ParallelChillerWithStagingControl
  ...
  chiller_tes_plant_controller_Donghun chiller_tes_plant_controller_D
  ...
  Buildings.Fluid.FixedResistances.Junction junDiv(
    ...
    dp_nominal={0,0,0}) annotation (Placement(transformation(
        ...
        rotation=0,
        origin={-142,-2})));
  campus_chiller_plant.Plants.Subsequences.ChillerStagingDataProcessing
    chillerStagingDataProcessing annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={-162,-50})));
  ...
  Buildings.Fluid.Movers.FlowControlled_m_flow Pump_CHW_Primary2(
    ...
    "Pump for chilled water loop" annotation (Placement(transformation(
        ...
        origin={44,-72})));
  campus_chiller_plant.Plants.Subsequences.ChillerStagingDataProcessing
    chillerStagingDataProcessing1 annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={6,-156})));
