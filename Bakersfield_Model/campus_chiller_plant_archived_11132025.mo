...
model campus_chiller_plant_archived_11132025 "Put another chiller"
  ...
  Buildings.Fluid.Storage.StratifiedEnhanced
    ...
    annotation (Placement(transformation(extent={{-13,-13},{13,13}},
        rotation=180,
        origin={263,-21})));
  campus_chiller_plant.Plants.Subsequences.plant_mode_controller
    chiller_tes_plant_controller
    annotation (Placement(transformation(extent={{170,184},{190,204}})));
  campus_chiller_plant.Plants.Subsequences.TesStatusController
    tesStatusController(tempDischargedBottom(displayUnit="degC") = 285.93,
      tempChargedTop(displayUnit="degC") = 278.71)
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort Sensor_TCHWS(redeclare package
      ...
      Placement(transformation(
        ...
        rotation=0,
        origin={312,90})));
  campus_chiller_plant.Plants.Subsequences.FmuPatch fmuPatch
  ...
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant con9(k=58*0.9997)
    annotation (Placement(transformation(extent={{246,236},{266,256}})));
  campus_chiller_plant.Plants.Subsequences.cooling_load_ScaleDown_controller
...
equation
  ...
  connect(con9.y, swi2.u3)
    annotation (Line(points={{268,246},{296,246},{296,256},{316,256}},
                                                             color={0,0,127}));
...
end campus_chiller_plant_archived_11132025;
