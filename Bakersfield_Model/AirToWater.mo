...
model AirToWater "Validation of AWHP plant template"
  ...
  Buildings.Fluid.Sensors.RelativePressure dpHeaWatRem_1(redeclare final
    ...
    "HW differential pressure at one remote location" annotation (Placement(
        ...
        rotation=-90,
        origin={40,-120})));
  Buildings.Fluid.Sensors.RelativePressure dpChiWatRem_1(redeclare final
  ...
  Buildings.Templates.AirHandlersFans.Interfaces.Bus busAirHan
    "AHU control bus" annotation (Placement(transformation(extent={{-60,100},{-20,
            140}}), iconTransformation(extent={{-340,-140},{-300,-100}})));
  Buildings.Templates.Plants.HeatPumps.Interfaces.Bus busPla
    "Plant control bus" annotation (Placement(transformation(extent={{-100,-40},
            {-60,0}}), iconTransformation(extent={{-370,-70},{-330,-30}})));
