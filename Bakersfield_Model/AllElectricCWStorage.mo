...
model AllElectricCWStorage "All-electric CHW and HW plant with CW storage"
  ...
  replaceable parameter
    ...
    "Heat pump parameters (each unit)" annotation (Dialog(group=
          "CW loop, TES tank and heat pumps"), Placement(transformation(extent=
            {{160,340},{180,360}})));
  ...
  Buildings.DHC.Plants.Combined.Subsystems.MultiplePumpsSpeed pumChiWat(
    ...
    final energyDynamics=energyDynamics,
    final use_inputFilter=use_inputFilter,
    final allowFlowReversal=allowFlowReversal) "Primary CHW pumps"
  ...
  Buildings.Fluid.Actuators.Valves.TwoWayLinear valChiWatMinByp(
    ...
    dpValve_nominal=1E3,
    final use_inputFilter=use_inputFilter,
    final allowFlowReversal=allowFlowReversal) "CHW minimum flow bypass valve"
    annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=-90,
        origin={240,140})));
  Buildings.Fluid.Sensors.RelativePressure dpChiWat(redeclare final package
      Medium = Medium)
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort TChiWatPriRet(
    ...
    annotation (Placement(transformation(
        ...
        rotation=0,
        origin={220,80})));
  Buildings.Fluid.Sensors.MassFlowRate mChiWatPri_flow(redeclare final package
  ...
  Buildings.DHC.Plants.Combined.Subsystems.ChillerHeatRecoveryGroup chiHea(
    redeclare final package Medium = Medium,
    final dat=datChiHea,
    final nUni=nChiHea,
    ...
    final use_inputFilter=use_inputFilter,
    final energyDynamics=energyDynamics) "Heat recovery chillers"
  ...
  Buildings.Fluid.Actuators.Valves.TwoWayLinear valHeaWatMinByp(
    ...
    annotation (Placement(transformation(
        ...
        rotation=-90,
        origin={240,-200})));
  Buildings.Fluid.Sensors.RelativePressure dpHeaWat(redeclare final package
      Medium = Medium)
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort THeaWatSup(
    ...
    annotation (Placement(transformation(
        ...
        rotation=0,
        origin={210,-140})));
  Buildings.Fluid.Sensors.MassFlowRate mHeaWatPri_flow(redeclare final package
      Medium = Medium, final allowFlowReversal=allowFlowReversal)
  ...
  Buildings.DHC.Plants.Combined.Subsystems.HeatPumpGroup heaPum(
    ...
    final energyDynamics=energyDynamics,
    final use_inputFilter=use_inputFilter,
    final allowFlowReversal=allowFlowReversal) "Heat pumps"
  ...
  Buildings.DHC.Plants.Combined.Subsystems.CoolingTowerGroup coo(
    ...
    final energyDynamics=energyDynamics,
    final allowFlowReversal=allowFlowReversal) "Cooling towers"
  ...
  Buildings.Fluid.Actuators.Valves.ThreeWayLinear valBypTan(
    ...
    final energyDynamics=energyDynamics,
    dpValve_nominal=1E3,
    dpFixed_nominal={dpTan_nominal,dpHexCoo_nominal}) "TES tank bypass valve"
    annotation (Placement(transformation(
        extent={{-10,10},{10,-10}},
        rotation=90,
        origin={-160,-100})));
  Buildings.Fluid.Sources.Boundary_pT bouConWatCoo(
    redeclare final package Medium = Medium,
    final p=130000,
    nPorts=1) "CW pressure boundary condition prescribed by CT elevation head"
    annotation (Placement(transformation(
        extent={{10,-10},{-10,10}},
        rotation=-90,
        origin={-300,-250})));
  Buildings.DHC.Plants.Combined.Subsystems.MultiplePumpsSpeed pumConWatCoo(
    redeclare final package Medium = Medium,
  ...
  Buildings.Fluid.Sensors.RelativePressure dpConWatEva(redeclare final package
      Medium = Medium) "CW evaporator loop differential pressure " annotation (
      Placement(transformation(
        extent={{-10,10},{10,-10}},
        rotation=-90,
        origin={0,-70})));
  Buildings.Fluid.Sensors.RelativePressure dpConWatCon(redeclare final package
      Medium = Medium) "CW condenser loop differential pressure " annotation (
      Placement(transformation(
        extent={{10,-10},{-10,10}},
        rotation=-90,
        origin={-20,-310})));
  Buildings.Fluid.Sensors.MassFlowRate mConWatEva_flow(redeclare final package
      Medium = Medium, final allowFlowReversal=allowFlowReversal)
    "CW evaporator loop mass flow rate" annotation (Placement(transformation(
          extent={{40,-50},{60,-30}}, rotation=0)));
  Buildings.Fluid.Sensors.MassFlowRate mConWatCon_flow(redeclare final package
      Medium = Medium, final allowFlowReversal=allowFlowReversal)
    "CW condenser loop mass flow rate" annotation (Placement(transformation(
        extent={{-10,10},{10,-10}},
        rotation=-90,
        origin={-120,-320})));
  Buildings.Fluid.Sensors.MassFlowRate mConWatOutTan_flow(redeclare final
...
protected
  ...
  final parameter Modelica.Units.SI.SpecificHeatCapacity cpConWatCoo_default=
    ...
    "Specific heat capacity of the fluid";
public
  Buildings.Fluid.Sensors.MassFlowRate mConWatHexCoo_flow(redeclare final
      package Medium = Medium, final allowFlowReversal=allowFlowReversal)
