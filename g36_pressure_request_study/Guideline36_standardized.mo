...
model Guideline36_standardized
...
//     "Minimum expected zone primary flow rate";
  ...
  Controller_standardized                                         conAHU(
  ...
  Buildings.Controls.OBC.CDL.Integers.Switch intSwi[numZon]
    annotation (Placement(transformation(extent={{844,14},{864,34}})));
...
equation
  ...
  connect(conAHU.yHeaCoi, sysHysHea.u) annotation (Line(points={{544,504},{880,
          504},{880,-310},{-60,-310},{-60,-140},{-42,-140}},
                                                        color={0,0,127}));
  connect(conAHU.yCooCoi, sysHysCoo.u) annotation (Line(points={{544,510},{880,
          510},{880,-310},{0,-310},{0,-250},{18,-250}},
                                                   color={0,0,127}));
