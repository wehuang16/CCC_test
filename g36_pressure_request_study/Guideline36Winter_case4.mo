...
model Guideline36Winter_case4
  ...
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant con(k=790)
    annotation (Placement(transformation(extent={{-214,132},{-194,152}})));
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant con1(k=-310)
    annotation (Placement(transformation(extent={{-214,98},{-194,118}})));
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant con2(k=140)
    annotation (Placement(transformation(extent={{-212,68},{-192,88}})));
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant con3(k=-1010)
    annotation (Placement(transformation(extent={{-212,38},{-192,58}})));
...
equation
  ...
  connect(con.y, prescribedHeatFlow1.Q_flow) annotation (Line(points={{-192,142},
          {-178,142},{-178,106},{-112,106}}, color={0,0,127}));
  connect(con1.y, prescribedHeatFlow2.Q_flow)
    annotation (Line(points={{-192,108},{-152,108},{-152,88},{-112,88}},
                                                   color={0,0,127}));
  connect(con2.y, prescribedHeatFlow3.Q_flow) annotation (Line(points={{-190,78},
          {-178,78},{-178,68},{-112,68}}, color={0,0,127}));
  connect(con3.y, prescribedHeatFlow4.Q_flow) annotation (Line(points={{-190,48},
          {-178,48},{-178,54},{-112,54}}, color={0,0,127}));
  connect(con4.y, prescribedHeatFlow5.Q_flow) annotation (Line(points={{-192,12},
          {-180,12},{-180,38},{-112,38}}, color={0,0,127}));
  annotation (
    __Dymola_Commands(
