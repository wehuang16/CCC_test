...
model Floor_ClosedDoors "Model of a floor of the building"
  extends Buildings.Examples.VAVReheat.BaseClasses.PartialFloor(
    ...
    AFloEas=eas.AFlo,
    AFloWes=wes.AFlo,
    opeWesCor(wOpe=0.01, hOpe=0.01),
    opeSouCor(wOpe=0.01, hOpe=0.01),
    opeNorCor(wOpe=0.01, hOpe=0.01),
    opeEasCor(wOpe=0.01, hOpe=0.01),
    leaWes(
      s=18.46/27.69),
    leaSou(
      s=27.69/18.46),
...
equation
  ...
  connect(sou.ports[2],portsSou[2])
    annotation (Line(points={{163.2,-43.1},{164,-43.1},{164,-54},{86,-54},{86,
          -36},{95,-36}},                                                                     color={0,127,255},smooth=Smooth.None));
  ...
  connect(nor.ports[1],portsNor[1])
    annotation (Line(points={{162.4,116.9},{164,116.9},{164,106},{88,106},{88,
          124},{85,124}},                                                                    color={0,127,255},smooth=Smooth.None));
  connect(nor.ports[2],portsNor[2])
    annotation (Line(points={{163.2,116.9},{164,116.9},{164,106},{88,106},{88,
          124},{95,124}},                                                                     color={0,127,255},smooth=Smooth.None));
  ...
  connect(opeWesCor.port_a1,wes.ports[4])
    annotation (Line(points={{20,-4},{14,-4},{14,44},{30,44},{30,58.9},{32.8,
          58.9}},                                                                   color={0,127,255},smooth=Smooth.None,thickness=0.5));
  connect(opeWesCor.port_b2,wes.ports[5])
    annotation (Line(points={{20,-16},{14,-16},{14,44},{30,44},{30,58.9},{33.6,
          58.9}},                                                                     color={0,127,255},smooth=Smooth.None,thickness=0.5));
