...
model DirectValidation "Validation of the Direct block"
  ...
  CCC_test.ESTCP.Direct1 dirEvaCoo(
  ...
  CCC_test.ESTCP.Direct1 dirEvaCoo1(
    redeclare package Medium = Buildings.Media.Air,
    final padAre=padAre,
  ...
  CCC_test.ESTCP.Direct1 dirEvaCoo2(
    redeclare package Medium = Buildings.Media.Air,
    final padAre=padAre,
...
<a href=\"modelica://CCC_test.ESTCP.Direct1\">
