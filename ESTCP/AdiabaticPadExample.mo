...
model AdiabaticPadExample
  ...
  package MediumPropyleneGlycol =
      Buildings.Media.Antifreeze.PropyleneGlycolWater (property_T=273.15+50, X_a=
            0.4);
  AdiabaticPad adiabaticPad1(redeclare package Medium = MediumAir,
      m_flow_nominal=1)
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort temInt(redeclare package Medium =
        ...
        rotation=0,
        origin={26,-6})));
  AdiabaticPad adiabaticPad2(redeclare package Medium = MediumAir,
      m_flow_nominal=1)
