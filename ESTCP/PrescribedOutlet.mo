...
equation
  ...
  connect(setHeaHigPow.y[2], heaHigPow.X_wSet) annotation (Line(points={{-39,120},
          {-20,120},{-20,90},{-11,90}}, color={0,0,127}));
