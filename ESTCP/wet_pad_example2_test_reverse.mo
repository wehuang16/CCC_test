...
model wet_pad_example2_test_reverse
  ...
  package MediumPropyleneGlycol =
      Buildings.Media.Antifreeze.PropyleneGlycolWater (property_T=273.15+50, X_a=
            0.4);
  wet_pad2_test_reverse
          wet_pad1(redeclare package Medium = MediumAir, m_flow_nominal=1)
    annotation (Placement(transformation(extent={{50,-4},{30,18}})));
...
equation
  ...
  connect(temIn.port_b, wet_pad1.port_b)
    annotation (Line(points={{4,2},{18,2},{18,7},{30,7}}, color={0,127,255}));
  connect(wet_pad1.port_a, temOut.port_a) annotation (Line(points={{50,7},{66,7},
          {66,12},{80,12}}, color={0,127,255}));
...
end wet_pad_example2_test_reverse;
