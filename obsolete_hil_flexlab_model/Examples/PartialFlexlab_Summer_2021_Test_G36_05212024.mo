...
partial model PartialFlexlab_Summer_2021_Test_G36_05212024
  ...
  parameter Modelica.Units.SI.MassFlowRate mCor_flow_nominal=0.1274
    "*1.2Design mass flow rate core";
  parameter Modelica.Units.SI.MassFlowRate mSou_flow_nominal=0.2265
  ...
  parameter Modelica.Units.SI.MassFlowRate mNor_flow_nominal=0.1274
 ...
 //   "Design mass flow rate perimeter 3";
  parameter Modelica.Units.SI.MassFlowRate m_flow_nominal=1.0*(
      mCor_flow_nominal + mSou_flow_nominal + mNor_flow_nominal) "Nominal mass flow rate";
...
//    annotation (Placement(transformation(extent={{118,-36},{98,-56}})));
  ...
  hil_flexlab_model.Test1.ThermalZones.FloorG36 flo(redeclare final package
      Medium = MediumA, final use_windPressure=use_windPressure)
  ...
  Buildings.Fluid.Sensors.VolumeFlowRate VSupSou_flow(
    ...
    allowFlowReversal=allowFlowReversal) "Discharge air flow rate" annotation (
      Placement(transformation(
        ...
        rotation=90,
        origin={1080,128})));
  hil_flexlab_model.Test1.BaseClasses1.MixingBox eco(
    redeclare package Medium = MediumA,
...
public
  ...
  hil_flexlab_model.Test1.BaseClasses1.ParallelValvesFlow parallelValvesFlow(
      redeclare package Medium = MediumW)
    "determine the cooling coil mass flow rate" annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={242,-128})));
...
equation
  ...
  connect(splRetNor.port_1, dpRetDuc.port_a) annotation (Line(points={{764,0},{424,
          0},{424,140},{400,140}}, color={0,127,255}));
...
end PartialFlexlab_Summer_2021_Test_G36_05212024;
