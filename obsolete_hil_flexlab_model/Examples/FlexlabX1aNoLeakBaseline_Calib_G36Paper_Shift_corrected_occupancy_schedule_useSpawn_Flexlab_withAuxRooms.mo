...
model
  ...
  extends
    BaseClasses.PartialOpenLoopX1aV020123_modifyVav_useSpawn_Flexlab_withAuxRooms(
    occSch(
      occupancy={0,86399},
...
//      ave(nin=3));
  ...
  hil_flexlab_model.Plants.Controls.Controller_modifyHeatingSequence conVAVNor(
  ...
  hil_flexlab_model.Plants.Controls.Controller_modifyHeatingSequence conVAVCor(
  ...
  hil_flexlab_model.Plants.Controls.Controller_modifyHeatingSequence conVAVSou(
  ...
  hil_flexlab_model.BaseClasses.ModeAndSetPoints TZonSet[numZon](
  ...
  hil_flexlab_model.Plants.Controls.ExhaustDamperPositionBlock exhaustDamperPositionBlock
