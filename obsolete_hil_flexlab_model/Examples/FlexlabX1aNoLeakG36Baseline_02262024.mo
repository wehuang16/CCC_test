...
equation
  ...
  connect(exhaustDamperPositionBlock.ExhaustDamperPosition, eco.yExh)
    annotation (Line(points={{-85,-90},{-42,-90},{-42,2},{-3,2},{-3,-34}},
        color={0,0,127}));
...
end FlexlabX1aNoLeakG36Baseline_02262024;
