...
model FlexlabXRA "Model of a flexlab xra"
  ...
  parameter
    hil_flexlab_model.Data.Constructions.OpaqueConstructions.ExteriorConstructions.Construction9
    SouthExt
    annotation (Placement(transformation(extent={{-126,466},{-106,486}})));
  parameter
    hil_flexlab_model.Data.Constructions.OpaqueConstructions.Roofs.ASHRAE_901_1975Roof
    R20Wal annotation (Placement(transformation(extent={{-92,466},{-72,486}})));
  parameter
    hil_flexlab_model.Data.Constructions.OpaqueConstructions.DividingWalls.CellAndElectricalDividingWall
    R52Wal annotation (Placement(transformation(extent={{-54,466},{-34,486}})));
  parameter hil_flexlab_model.Data.Constructions.GlazingSystems.SingleClear3 glaSys(
      haveInteriorShade=false)
    annotation (Placement(transformation(extent={{-126,434},{-106,454}})));
  parameter
    hil_flexlab_model.Data.Constructions.OpaqueConstructions.PartitionConstructions.PartitionWall
    parCon annotation (Placement(transformation(extent={{-12,466},{8,486}})));
  parameter
    hil_flexlab_model.Data.Constructions.OpaqueConstructions.DividingWalls.TestCellDividngWall
    celDiv annotation (Placement(transformation(extent={{30,466},{50,486}})));
  parameter
    hil_flexlab_model.Data.Constructions.OpaqueConstructions.DividingWalls.TestBedDividingWall
    bedDiv annotation (Placement(transformation(extent={{-92,434},{-72,454}})));
  parameter
    hil_flexlab_model.Data.Constructions.OpaqueConstructions.DividingWalls.TestZoneDividngWall
    zonDiv
    annotation (Placement(transformation(extent={{-126,398},{-106,418}})));
  parameter
    hil_flexlab_model.Data.Constructions.OpaqueConstructions.ExteriorConstructions.Construction1
    WestExt
    annotation (Placement(transformation(extent={{-126,368},{-106,388}})));
  parameter
    hil_flexlab_model.Data.Constructions.OpaqueConstructions.Roofs.CeilingTile ceiling
    annotation (Placement(transformation(extent={{-90,368},{-70,388}})));
  parameter
    hil_flexlab_model.Data.Constructions.OpaqueConstructions.ExteriorConstructions.Construction3
    NorthExt annotation (Placement(transformation(extent={{-12,434},{8,454}})));
  parameter
    hil_flexlab_model.Data.Constructions.OpaqueConstructions.ExteriorConstructions.ExteriorDoorInsulated
    extDoo annotation (Placement(transformation(extent={{30,434},{50,454}})));
  parameter
    hil_flexlab_model.Data.Constructions.OpaqueConstructions.PartitionConstructions.PartitionDoor
  ...
  parameter
    hil_flexlab_model.Data.Constructions.OpaqueConstructions.ExteriorConstructions.ExteriorDoorUninsulated
    extDooUn
  ...
  CCC_test.obsolete_hil_flexlab_model.ThermalZones.XRA.TestCell testCell(
  ...
  CCC_test.obsolete_hil_flexlab_model.ThermalZones.XRA.Closet closet(redeclare
      package Medium = Medium)
    annotation (Placement(transformation(extent={{176,362},{216,402}})));
  CCC_test.obsolete_hil_flexlab_model.ThermalZones.XRA.Electrical electrical(
      redeclare package Medium = Medium)
