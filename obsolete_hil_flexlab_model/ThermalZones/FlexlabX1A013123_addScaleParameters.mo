...
model FlexlabX1A013123_addScaleParameters "Model of a flexlab x1a"
  ...
  parameter hil_flexlab_model.Data.Constructions.GlazingSystems.SingleClear3 glaSys(glass={
        hil_flexlab_model.Data.Constructions.Glasses.ID104(tauSol={0.32*tauFra})},
