...
model RoomMultiFluid
  ...
  InternalLoad lig(
    radFraction=0.37,
    latPower_nominal=0,
    senPower_nominal=15.07)
    annotation (Placement(transformation(extent={{-280,16},{-260,36}})));
  InternalLoad equ(
    latPower_nominal=0,
    senPower_nominal=15,
    radFraction=0.5)
    annotation (Placement(transformation(extent={{-280,88},{-260,108}})));
  OccupancyLoad occ1(
    radFraction=0.6,
...
equation
  ...
  connect(senTZonMeaRad.T, TRooMeaRad)
    annotation (Line(points={{183,-30},{210,-30}}, color={0,0,127}));
  ...
  connect(proOcc1.y, sumCon.u[1]) annotation (Line(points={{-195,176},{-152,176},
          {-152,126.6},{-140,126.6}}, color={0,0,127}));
  ...
  connect(proOcc2.y, sumLat.u[1]) annotation (Line(points={{-219,154},{-150,154},
          {-150,104.6},{-140,104.6}}, color={0,0,127}));
