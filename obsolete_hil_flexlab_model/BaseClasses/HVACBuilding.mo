...
partial model HVACBuilding
  ...
  replaceable ThermalZones.PartialFloor flo constrainedby
    ThermalZones.PartialFloor(redeclare final package Medium = MediumA)
    "Building" annotation (Placement(transformation(extent={{20,40},{90,80}})));
