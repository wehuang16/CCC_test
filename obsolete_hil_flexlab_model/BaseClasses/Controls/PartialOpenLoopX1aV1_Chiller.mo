...
//    annotation (Placement(transformation(extent={{118,-36},{98,-56}})));
  ...
  CCC_test.obsolete_hil_flexlab_model.ThermalZones.FlexlabX1A flo(
...
equation
  ...
  connect(amb.ports[1], VOut1.port_a) annotation (Line(
      points={{-114,-46.65},{-94,-46.65},{-94,-33},{-72,-33}},
      color={0,127,255},
      smooth=Smooth.None,
      thickness=0.5));
  ...
  connect(dpDisSupFan.port_b, amb.ports[3]) annotation (Line(
      points={{320,10},{320,14},{-88,14},{-88,-44.45},{-114,-44.45}},
      color={0,0,0},
      pattern=LinePattern.Dot));
  ...
  connect(amb.ports[4], chi.port_b1) annotation (Line(points={{-114,-43.35},{70,
          -43.35},{70,-326},{252,-326}},
                                 color={0,127,255}));
