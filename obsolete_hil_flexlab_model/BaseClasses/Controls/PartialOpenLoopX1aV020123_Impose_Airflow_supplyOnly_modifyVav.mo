within CCC_test.obsolete_hil_flexlab_model.BaseClasses.Controls;
...
//    annotation (Placement(transformation(extent={{118,-36},{98,-56}})));
  ...
  hil_flexlab_model.ThermalZones.VAVBranch_useResistantReheatCoil nor(
  ...
  hil_flexlab_model.ThermalZones.VAVBranch_useResistantReheatCoil cor(
    redeclare package MediumA = MediumA,
    redeclare package MediumW = MediumW,
  ...
  hil_flexlab_model.ThermalZones.VAVBranch_useResistantReheatCoil sou(
    redeclare package MediumA = MediumA,
    redeclare package MediumW = MediumW,
  ...
  CCC_test.obsolete_hil_flexlab_model.ThermalZones.FlexlabX1A013123 flo(
...
equation
  ...
  connect(VSupPle_flow.port_b, flo.portsPle[1]) annotation (Line(points={{578,138},
          {578,566},{1004,566},{1004,442.48},{1003.57,442.48}}, color={0,127,255}));
  connect(VSupNor_flow.port_b, flo.portsNor[1]) annotation (Line(points={{706,140},
          {706,481.18},{899,481.18}},     color={0,127,255}));
  connect(VSupCor_flow.port_b, flo.portsCor[1]) annotation (Line(points={{834,142},
          {834,302},{802,302},{802,446},{858,446},{858,446.78},{899,446.78}},
        color={0,127,255}));
  ...
  connect(splRetCor.port_3, flo.portsCor[2]) annotation (Line(points={{952,10},
          {952,304},{864,304},{864,428},{906,428},{906,446.78},{903.286,446.78}},
        color={0,127,255}));
  connect(splRetNor.port_3, flo.portsNor[2]) annotation (Line(points={{774,10},
          {774,458},{908,458},{908,482},{903.286,482},{903.286,481.18}},color={0,
          127,255}));
